...
function showtime()
{
  ...
  if (dateLeft > 0)
  {
    Temp = dateLeft + ' <font>'+ _day + '</font> '+ hourZero + hourLeft + ' <font>'+ _hour + '</font> '+ minuteZero + minuteLeft + ' <font>'+ _minute + '</font> '+ secondZero + secondLeft + ' <font>'+ _second+ '</font>';
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = hourLeft + ' <font>'+ _hour + '</font> '+ minuteZero + minuteLeft + ' <font>'+ _minute + '</font> '+ secondZero + secondLeft + ' <font>'+ _second+ '</font>';
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = minuteLeft + ' <font>'+ _minute + '</font> '+ secondZero + secondLeft + ' <font>'+ _second+ '</font>';
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = secondLeft + ' <font>'+ _second+ '</font>';
        }
        else
        {
          Temp = ' ';
