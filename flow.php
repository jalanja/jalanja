...
elseif ($_REQUEST['step'] == 'add_to_cart_showDiv')
{
	...
	$result['show_info'] = insert_show_div_info($result['goods_number'],$result['script_name'],$result['goods_id'],$result['goods_recommend'],price_format($cart_goods['total']['goods_amount']),$cart_goods['total']['real_goods_count']);
