...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" href="<?php echo $this->_var['jump_http_referer']; ?>"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1><?php echo $this->_var['lang']['y_cart']; ?></h1>
...
<div class="cart-step" id="J_cartTab">
  <ul>
    <li class="cur">1,<?php echo $this->_var['lang']['cart_detail']; ?></li>
    <li>2,<?php echo $this->_var['lang']['confirm_order']; ?></li>
    <li>3,<?php echo $this->_var['lang']['order_success']; ?></li>
  </ul>
</div>
...
<footer class="toolbar">
  <p><?php echo $this->_var['lang']['subtotal']; ?>: <em class="price" id="goods_subtotal"><?php echo $this->_var['total']['goods_price']; ?></em></p>
  <a href="flow.php?step=checkout"><?php echo $this->_var['lang']['y_to_cart_settle']; ?>(<em class="num" id="total_number"><?php echo $this->_var['total']['real_goods_count']; ?></em>)</a> </footer>
<?php else: ?>
<section class="wrap"  >
  <div class="empty-cart">
    <div class="ico_13 cart-logo"></div>
    <p class="message"><?php echo $this->_var['lang']['no_goods_in_cart']; ?></p>
    <div class="flex"> <a class="c-btn2  flex_in radius5" href="index.php" style=" background:#6bd0a2"> <i class="ico_04_b"></i> <?php echo $this->_var['lang']['go_shopping']; ?> </a> <a class="c-btn2  flex_in radius5" href="user.php?act=collection_list" style=" margin-left:0.5rem"> <?php echo $this->_var['lang']['collect_goods']; ?></a> </div>
  </div>
</section>
<?php endif; ?> 
...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" href="flow.php?step=cart"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1> <?php echo $this->_var['lang']['consignee_address']; ?> </h1>
  </header>
</div>
<div class="cart-step" id="J_cartTab">
  <ul>
    <li>1,<?php echo $this->_var['lang']['cart_detail']; ?></li>
    <li  class="cur">2,<?php echo $this->_var['lang']['confirm_order']; ?></li>
    <li>3,<?php echo $this->_var['lang']['order_success']; ?></li>
  </ul>
</div>
<div class="blank3"></div>
...
?>
  <?php echo $this->_var['consignee']['consignee']; ?>
...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" href="flow.php"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1> <?php echo $this->_var['lang']['confirm_order']; ?> </h1>
  </header>
</div>
<div class="cart-step" id="J_cartTab">
  <ul>
  ...
  <form action="flow.php" method="post" name="theForm" id="theForm" onSubmit="return checkOrderForm(this)">
    ...
    <section class="order_box padd1 radius10" style="padding-top:0">
      <div class="in">
        <div class="table_box table_box1">
          ...
          <dl>
            <dd class="w50 b_no" ><?php echo $this->_var['lang']['detailed_address']; ?> <?php echo htmlspecialchars($this->_var['consignee']['address']); ?> 
    ...
    <section class="order_box padd1 radius10" style="padding-top:0.3rem;padding-bottom:0.3rem;">
      <div class="table_box table_box2"> 
        ...
        <dl>
          <dd class="dd1"><?php echo $this->_var['lang']['shipping_method']; ?> <span class="span1 radius5"><?php echo $this->_var['lang']['require_field']; ?></span></dd>
          <dd class="dd2" id="selected1"><?php echo $this->_var['lang']['flow_js']['shipping_not_null']; ?></dd>
          <i></i>
        </dl>
...
?>
        ...
        <dl>
          <dd class="dd1"><?php echo $this->_var['lang']['payment_method']; ?> <span class="span1 radius5"><?php echo $this->_var['lang']['require_field']; ?></span></dd>
          <dd class="dd2 selectPayment" id="selected2"><?php echo $this->_var['lang']['flow_js']['payment_not_null']; ?></dd>
          <i></i>
        </dl>
...
?>
        ...
        <!--  <dd class="dd1"><?php echo $this->_var['lang']['invoice']; ?> ?</dd>
		  <span class="modRadio fr" style="margin-top: 10px;">
            <i class="fl"></i>
            <ins><?php echo $this->_var['lang']['no']; ?></ins>
         </span>  -->
        </dl>
    ...
    <section class="order_box padd1 radius10" style="padding-top:0.3rem;padding-bottom:0.3rem;">
      <div class="table_box table_box2" style=" margin-bottom:0.5rem"> 
        ...
        <dl>
          ...
          <dd class="dd2" id="selected4"> <?php echo $this->_var['lang']['not_selected']; ?> </dd>  
          <i></i>
        </dl>
...
?>
        ...
        <dl class="b_no">
          <dd class="dd1"><?php echo $this->_var['lang']['goods_package']; ?></dd>
		   <dd class="dd2" id="selected5"> <?php echo $this->_var['lang']['not_selected']; ?> </dd>  
           <i></i>
        </dl>
...
?>
        ...
        <dl class="b_no">
          <dd class="dd1"><?php echo $this->_var['lang']['goods_card']; ?></dd>
           <dd class="dd2" id="selected6"> <?php echo $this->_var['lang']['not_selected']; ?> </dd>  
          <i></i>
        </dl>
...
?>
		...
		<div class="dl_box">
		 <dl>
				<dd class="c333">
				<?php echo $this->_var['lang']['message_content']; ?>
				</dd>
				<dd >	
			<input placeholder="<?php echo $this->_var['lang']['y_fill_in']; ?>" name="inv_payee" type="text"   size="20"  />
				 </dd>
		 </dl>
		 <dl>
				<dd class="c333">
...
?>
    ...
    <div class="blank3"></div>
    <input type="submit" name="submit" value="<?php echo $this->_var['lang']['confirm_submit']; ?>" class="c-btn3" />
...
<header id="header">
    <div class="header_l"> <a class="ico_10" href="index.php"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1> <?php echo $this->_var['lang']['order_success']; ?> </h1>
</header>
<div class="cart-step" id="J_cartTab">
  <ul>
    <li>1.<?php echo $this->_var['lang']['cart_detail']; ?></li>
    <li>2.<?php echo $this->_var['lang']['confirm_order']; ?></li>
    <li class="cur">3.<?php echo $this->_var['lang']['order_success']; ?></li>
  </ul>
</div>
<div class="blank3"></div>
...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" onClick="javascript:history.go(-1)"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1> <?php echo $this->_var['lang']['regist_login']; ?> </h1>
  </header>
</div>
<div class="cart-step" id="J_cartTab">
  <ul>
...
?>
  ...
  <div id="leftTabBox" class="loginBox">
    <div class="hd">
      <ul>
         <li<?php if ($this->_var['action'] == 'login'): ?> class="on"<?php endif; ?>><a><?php echo $this->_var['lang']['label_login']; ?></a></li>
         <li<?php if ($this->_var['action'] == 'register'): ?> class="on"<?php endif; ?>><a><?php echo $this->_var['lang']['reg_now']; ?></a></li>
      </ul>
    </div>
    <div class="bd" id="tabBox1-bd" <?php if ($this->_var['action'] == 'register'): ?> style="display:none"<?php endif; ?>>
      ...
      <div class="table_box">
          <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
            ...
            <dl>
              <dd>
                <input type="checkbox" value="1" name="remember" id="remember" style="vertical-align:middle; zoom:200%;" /><label for="remember"> <?php echo $this->_var['lang']['remember']; ?></label>
              </dd>
            </dl>
            <dl>
              <dd>
                 <input type="submit" name="login" class="c-btn3" value="<?php echo $this->_var['lang']['login_now']; ?>" />
          ...
          <dl>
            <dd> <a href="user.php?act=get_password" class="f6"><?php echo $this->_var['lang']['forgot_password']; ?></a> </dd>
          </dl>
          <div class="hezuo">
            <p class="t"><?php echo $this->_var['lang']['social_login']; ?></p>
        ...
        <form action="user.php" method="post" name="formUser" onsubmit="return register2();">
          ...
          <div class="table_box">
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['a_input_tlp']; ?>" class="inputBg" name="mobile" id="mobile_phone" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['a_input_accpwd']; ?>" class="inputBg" name="password" id="mobile_pwd" type="password" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['a_input_captha']; ?>" class="inputBg" name="mobile_code" id="mobile_code" type="text" />
              </dd>
              <dd>
              <input id="zphone" name="sendsms" type="button" value="<?php echo $this->_var['lang']['a_get_tlp_code']; ?>" onClick="sendSms();" class="c-btn3" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input id="agreement" name="agreement" type="checkbox" value="1" checked="checked" style="vertical-align:middle; zoom:200%;" /><label for="agreement"> <?php echo $this->_var['lang']['agreement']; ?></label>
              </dd>
            </dl>
            <dl>
              <dd>
                ...
                <input name="Submit" type="submit" value="<?php echo $this->_var['lang']['reg_now']; ?>" class="c-btn3" />
              </dd>
            </dl>
          </div>
        </form>
        ...
        <form action="user.php" method="post" name="formUser" onsubmit="return register();">
          ...
          <div class="table_box">
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['username']; ?>" class="inputBg" name="username" id="username" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['email']; ?>" class="inputBg" name="email" id="email" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['a_input_accpwd']; ?>" class="inputBg" name="password" id="password1" type="password" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['confirm_password']; ?>" class="inputBg" name="confirm_password" id="confirm_password" type="password" />
              </dd>
            </dl>
            <?php if ($this->_var['enabled_captcha']): ?>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['a_input_captha']; ?>" class="inputBg" name="captcha" id="captcha" type="text" />
              </dd>
              <dd>
