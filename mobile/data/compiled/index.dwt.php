...
<div id="page">
  <header id="header" >
    <div class="header_l"> <a class="ico_02" href="#menu"> <?php echo $this->_var['lang']['a_menu']; ?> </a> </div>
    <h1> <?php echo $this->_var['shop_name']; ?> </h1>
    <div class="header_r"> <a class="ico_01" href="flow.php"> <?php echo $this->_var['lang']['y_cart']; ?> </a> </div>
  </header>
</div>
...
<?php $this->assign('ads_id','1'); ?><?php $this->assign('ads_num','2'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?>
    ...
    <div class=content>
      <div id=fake-search>
        <div class="fakeInput box1 radius15">
          <button class="text" id="get_search_box" style="color:silver;"><?php echo $this->_var['lang']['search_goods']; ?></button>
...
<?php $this->assign('cat_goods',$this->_var['cat_goods_165']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_165']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
<?php $this->assign('cat_goods',$this->_var['cat_goods_152']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_152']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
<?php $this->assign('cat_goods',$this->_var['cat_goods_207']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_207']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
