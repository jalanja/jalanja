...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" onClick="javascript:history.back();"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
...
<section class="wrap">
  <div id="leftTabBox" class="loginBox">
    <div class="hd">
      <ul>
        <li<?php if ($this->_var['action'] == 'login'): ?> class="on"<?php endif; ?>><a href="javascript:void(0)"><?php echo $this->_var['lang']['login_now']; ?></a></li>
        <li<?php if ($this->_var['action'] == 'register'): ?> class="on"<?php endif; ?>><a href="javascript:void(0)"><?php echo $this->_var['lang']['reg_now']; ?></a></li>
      </ul>
    </div>
          ...
          <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
            ...
            <dl>
              <dd>
                ...
                <input type="submit" name="submit"  value="<?php echo $this->_var['lang']['login_now']; ?>" class="c-btn3" />
              </dd>
            </dl>
          </form>
          <dl>
      ...
      <ul style="height:25rem">
        ...
        <form action="user.php" method="post" name="formUser" onsubmit="return register();">
          ...
          <div class="table_box">
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['member_name']; ?>" class="inputBg" name="username" id="username" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['label_email']; ?>" class="inputBg" name="email" id="email" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="<?php echo $this->_var['lang']['label_password']; ?>" class="inputBg" name="password" id="password1" type="password" />
              </dd>
            </dl>
            <dl>
              <dd>
...
<div id="page">
  <header id="header">
    <div class="header_l"> <a class="ico_10" onClick="javascript:history.back();"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
    <h1> <?php echo $this->_var['lang']['a_reset_pwd']; ?> </h1>
  </header>
</div>
<section class="wrap">
  <div id="leftTabBox" class="loginBox">
    <div class="hd"> <span><?php echo $this->_var['lang']['a_can_use']; ?> <?php if ($this->_var['enabled_sms_signin'] == 1): ?> <?php echo $this->_var['lang']['a_sms']; ?><?php echo $this->_var['lang']['mobile']; ?> <?php else: ?><?php echo $this->_var['lang']['label_email']; ?> <?php endif; ?><?php echo $this->_var['lang']['a_reset_pwd']; ?></span>
    </div>
    <div id="tabBox1-bd">
      <ul>
      	<?php if ($this->_var['enabled_sms_signin'] == 1): ?>
