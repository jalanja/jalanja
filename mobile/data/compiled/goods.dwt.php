...
<body>
<header id="header">
  <div class="header_l header_return"> <a class="ico_10" href="cat_all.php"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
  <h1> <?php echo $this->_var['lang']['treasure_info']; ?> </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=<?php echo $this->_var['goods']['goods_name']; ?>&pic=<?php echo $this->_var['goods']['original_img']; ?>"> <?php echo $this->_var['lang']['y_share_to']; ?> </a> </div>
</header>
...
?>
    <li><?php echo $this->_var['lang']['shop_price']; ?>: <b class="price" id="ECS_RANKPRICE_<?php echo $this->_var['key']; ?>"><?php echo $this->_var['rank_price']['price']; ?></b></li>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  </ul>
  <?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?> 
  <?php echo $this->smarty_insert_scripts(array('files'=>'lefttime.js')); ?>
  <ul>
    <li> <span class="time"><?php echo $this->_var['lang']['residual_time']; ?>: <time class="countdown" id="leftTime"><?php echo $this->_var['lang']['please_waiting']; ?></time></span> </li>
  </ul>
  <?php endif; ?>
...
?>
  ...
  <ul>
  <!--  <li><?php echo $this->_var['lang']['y_list_volume']; ?><?php echo $this->_var['sales_count']; ?><?php echo $this->_var['lang']['y_a_piece']; ?></li>    stop sales count first-->
  </ul>
</section>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div><?php echo $this->_var['lang']['please_select']; ?><span><?php $_from = $this->_var['specification']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('spec_key', 'spec');$this->_foreach['spec'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                    ...
                    <label for="spec_value_<?php echo $this->_var['value']['id']; ?>"><?php if ($this->_var['value']['product_number'] == 0): ?><?php echo $this->_var['value']['label']; ?>-<font class="price"><?php echo $this->_var['lang']['stock_up']; ?></font><?php else: ?><?php echo $this->_var['value']['label']; ?>-<font class="price"><?php echo $this->_var['value']['product_number']; ?><?php echo $this->_var['goods']['measure_unit']; ?></font><?php endif; ?></label> 
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>					
                    <?php else: ?>
					<?php $_from = $this->_var['spec']['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'value');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['value']):
...
?>
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(<?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['lang']['y_to_cart_settle']; ?></button>
        <button type="button" class="btn cart radius5" onclick="addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);">
        <div class="ico_01"></div>
        <?php echo $this->_var['lang']['a_to_cart']; ?></button>
        
        <div class="tipMask" id="hidDiv" style="display:none" ></div>
        <div class="popGeneral" id="popDiv" >
          <div class="tit">
            <h4><?php echo $this->_var['lang']['view_cart']; ?></h4>
          ...
          <div id="main">
            ...
            <div id="right">
              ...
              <span> <?php echo $this->_var['lang']['number']; ?>: <b id="cartNum"></b></span> <span> <?php echo $this->_var['lang']['ws_subtotal']; ?>: <b id="cartPrice"></b></span> 
            </div>
          </div>
          <div class="popbtn"> <a class="bnt1 flex_in radius5" onclick="closeDiv()" href="javascript:void(0);"><?php echo $this->_var['lang']['go_shopping']; ?> </a> <a class="bnt2 flex_in radius5" href="flow.php"><?php echo $this->_var['lang']['y_to_cart_settle']; ?></a> </div>
        </div>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      <li id="tabs1" onClick="tab(1)" class="current"> <?php echo $this->_var['lang']['y_goods_detail']; ?> </li>
      <li id="tabs2" onClick="tab(2)" class=""> <?php echo $this->_var['lang']['y_goods_comments']; ?> <span class="review-count">(<?php echo $this->_var['goods']['comment_count']; ?>)</span> </li>
      <li id="tabs3" onClick="tab(3)" class=""> <?php echo $this->_var['lang']['y_hot_sales_charts']; ?> </li>
    </ul>
  </header>
  <div id="tab1" class="">
    <div class="desc wrap">
