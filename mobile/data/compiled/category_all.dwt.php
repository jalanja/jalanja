...
<body>
<header id="header">
  <div class="header_l header_return"> <a class="ico_10" href="index.php"> <?php echo $this->_var['lang']['back_up_page']; ?> </a> </div>
  <h1> <?php echo $this->_var['lang']['all_category']; ?> </h1>
  <div class="header_r header_search"> <a class="ico_03"  onClick="showSearch()"> <?php echo $this->_var['lang']['search']; ?> </a> </div>
  <div id="search_box">
