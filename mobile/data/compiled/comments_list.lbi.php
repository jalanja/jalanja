...
<li class="radius5">
	...
	<p><?php echo $this->_var['lang']['y_goods_score']; ?>:<img src="<?php echo $this->_var['ectouch_themes']; ?>/images/stars<?php echo $this->_var['comment']['rank']; ?>.png" class="star" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /></p>
	<p><?php echo $this->_var['lang']['comments_rank']; ?>:<?php echo $this->_var['comment']['content']; ?></p>
       ...
       <div id="pagebar" class="f_r">
        ...
        <div id="pager" style="padding:10px 0">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span>  <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a>  </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_46747500_1434362734');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_46747500_1434362734']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_46747500_1434362734']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
 ...
 <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="" >
     ...
     <tr>
          ...
          <td>
          <input name="comment_rank" type="radio" value="1" checked="checked" id="comment_rank5" /> Great
          <input name="comment_rank" type="radio" value="2" id="comment_rank4" /> Good
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" /> Soso
          <input name="comment_rank" type="radio" value="4" id="comment_rank2" /> Bad
          <input name="comment_rank" type="radio" value="5" id="comment_rank1" /> Terrible
          </td>
        </tr>
          <td>
        ...
        <?php endif; ?>
        <tr>
          <td><input type="submit" name="submit" value="<?php echo $this->_var['lang']['submit_comment']; ?>" class="c-btn3" /></td>
        </tr>
      </table>
      </form>
      </div>
...
<script type="text/javascript">
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_46779300_1434362734');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_46779300_1434362734']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_46779300_1434362734']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
