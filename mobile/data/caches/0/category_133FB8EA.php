<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:62:"/home/indojalanja_gmail_com/mobile/themes/miqinew/category.dwt";i:1;s:72:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/goods_list.lbi";i:2;s:73:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1434281131;s:8:"maketime";i:1434277531;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>Baby Bath_Perlengkapan Baby_Tempat Belanja Susu dan Popok Bayi Online Terlengkap | Jalanja Touch Screen</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=197&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">Standard</a> </li>
      <li class=""> <a href="category.php?category=197&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list"><i class="f-ico-arrow-d"></i>Review</a> </li>
      <li class=""> <a href="category.php?category=197&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC#goods_list">Sold</a></li>
      <li class=""> <a href="category.php?category=197&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">Price <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="106">Konicare</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="110">Pigeon</a></li>
                        <input type="hidden" name="brand" value="0" />
          </ul>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="22000|26000">22000&nbsp;-&nbsp;26000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="26000|30000">26000&nbsp;-&nbsp;30000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="38000|42000">38000&nbsp;-&nbsp;42000</a></li>
                        <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:;">More<i></i></a> </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=197&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
