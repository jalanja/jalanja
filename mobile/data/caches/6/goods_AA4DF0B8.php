<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:59:"/home/indojalanja_gmail_com/mobile/themes/miqinew/goods.dwt";i:1;s:70:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/comments.lbi";i:2;s:73:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1434113393;s:8:"maketime";i:1434109793;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>Ensure Fos, Coklat, 1000gr_Lain_Food_Mama Product_Tempat Belanja Susu dan Popok Bayi Online Terlengkap | Jalanja Touch Screen</title>
...
<header id="header">
  ...
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=Ensure Fos, Coklat, 1000gr&pic=images/201504/source_img/1653_G_1429675458917.jpg"> Share </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201504/thumb_img/1653_thumb_G_1429675458018.jpg"  alt="Ensure Fos, Coklat, 1000gr" /></a></div>-->
      <ul>
        <li><a href="javascript:showPic()"><img alt="" src="http://www.jalanja.com/images/201504/source_img/1653_G_1429675458917.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(1653)" style="display: inline;"></a>
  <div class="title">
    <h1> Ensure Fos, Coklat, 1000gr </h1>
  </div>
  <ul>
        <li>Jalanja Price: <b class="price">Rp<span>258,000</span></b>　    <del>Rp<span>309,600</span></del> 
    </li>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(1653)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields">	 
        <ul class="ul1">
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(1653)">Checkout now</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(1653);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://www.jalanja.com/images/201504/source_img/1653_G_1429675458917.jpg"> </div>
            <div id="right">
              <p>Ensure Fos, Coklat, 1000gr</p>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
      <p>&nbsp;<strong style="color: rgb(64, 64, 64); font-family: verdana; line-height: 12px; margin: 0px; padding: 0px;">Manfaat</strong></p>
<ul style="margin: 0px; padding: 0px; line-height: 12px; color: rgb(64, 64, 64); font-family: verdana;">
    <li style="margin: 0px; padding: 0px; list-style: none;">Memberikan dan melengkapi kebutuhan nutrisi harian untuk beraktivitas</li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Pembentukan dan mempertahankan kepadatan tulang</li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Sumber serat pangan (4gr/100gr)</li>
    <li style="margin: 0px; padding: 0px; list-style: none;">&nbsp;</li>
</ul>
<p style="margin: 0px; padding: 0px; line-height: 12px; color: rgb(64, 64, 64); font-family: verdana;"><strong style="margin: 0px; padding: 0px;">Kelebihan</strong></p>
<p style="margin: 0px; padding: 0px; line-height: 12px; color: rgb(64, 64, 64); font-family: verdana;">&nbsp;</p>
<ul style="margin: 0px; padding: 0px; line-height: 12px; color: rgb(64, 64, 64); font-family: verdana;">
    <li style="margin: 0px; padding: 0px; list-style: none;">Mengandung&nbsp;<span style="margin: 0px; padding: 0px;">Protein, Karbohidrat,&nbsp;</span>dan&nbsp;<span style="margin: 0px; padding: 0px;">Lemak</span></li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Mengandung 12&nbsp;<span style="margin: 0px; padding: 0px;">Vitamin&nbsp;</span>dan 7&nbsp;<span style="margin: 0px; padding: 0px;">Mineral</span></li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Sebagai sumber serat pangan</li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Mengandung&nbsp;<span style="margin: 0px; padding: 0px;">Kalsium</span>&nbsp;yang tinggi</li>
    <li style="margin: 0px; padding: 0px; list-style: none;">Mengandung&nbsp;<span style="margin: 0px; padding: 0px;">Zinc&nbsp;</span>dan&nbsp;<span style="margin: 0px; padding: 0px;">Selenium</span></li>
    <li style="margin: 0px; padding: 0px; list-style: none;">&nbsp;</li>
</ul>
<p style="margin: 0px; padding: 0px; line-height: 12px; color: rgb(64, 64, 64); font-family: verdana;">&nbsp;</p>    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1653";}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
