<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:59:"/home/indojalanja_gmail_com/mobile/themes/miqinew/goods.dwt";i:1;s:70:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/comments.lbi";i:2;s:73:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1434179027;s:8:"maketime";i:1434175427;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>Sustagen School 6+, Vanila, 3-6 Tahun, 350gr_Susu Anak_Susu Bayi_Baby Feeding_Tempat Belanja Susu dan Popok Bayi Online Terlengkap | Jalanja Touch Screen</title>
...
<header id="header">
  ...
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=Sustagen School 6+, Vanila, 3-6 Tahun, 350gr&pic=images/201503/source_img/1684_G_1427744225746.jpg"> Share </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201503/thumb_img/1684_thumb_G_1427744225789.jpg"  alt="Sustagen School 6+, Vanila, 3-6 Tahun, 350gr" /></a></div>-->
      <ul>
        <li><a href="javascript:showPic()"><img alt="" src="http://www.jalanja.com/images/201503/source_img/1684_G_1427744225746.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(1684)" style="display: inline;"></a>
  <div class="title">
    <h1> Sustagen School 6+, Vanila, 3-6 Tahun, 350gr </h1>
  </div>
  <ul>
        <li>Jalanja Price: <b class="price">Rp<span>61,000</span></b>　    <del>Rp<span>73,200</span></del> 
    </li>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(1684)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields">	 
        <ul class="ul1">
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(1684)">Checkout now</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(1684);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://www.jalanja.com/images/201503/source_img/1684_G_1427744225746.jpg"> </div>
            <div id="right">
              <p>Sustagen School 6+, Vanila, 3-6 Tahun, 350gr</p>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
      <p>&nbsp;Sustagen School 6+ Baru, susu pertumbuhan bernutrisi yang diformulasikan  khusus untuk anak-anak usia <b>6-12</b>  tahun. Sustagen School 6+ Baru dengan  DHA, Prebiotik (Inulin),Protein  serta 12 vitamin dan 10 mineral untuk  membantu memenuhi nutrisi anak.</p>
<ul>
    <li><b>Protein</b>: Membantu membangun dan memperbaiki jaringan tubuh.</li>
    <li><b>Prebiotik (Inulin)</b>: Serat pangan inulin dapat membantu mempertahankan fungsi saluran pencernaan.</li>
    <li><b>Vitamin dan Mineral</b>:
    <ul>
        <li><b>Vitamin A,</b> dapat membantu mempertahankan keutuhan lapisan permukaan (mukosa).</li>
        <li><b>Vitamin C,</b> sebagai antioksidan yang bekerja bersama antioksidan lain terutama Vitamin E.</li>
        <li><b>Vitamin B2,</b> berperan sebagai ko-enzim dalam reaksi pembentukan energi.</li>
        <li><b>Zat Besi,</b> membantu mencegah dan mengatasi anemia defisiensi zat besi.</li>
        <li><b>Kalium,</b> berperan dalam pembentukan tulang dan mempertahankan kepadatan tulang dan gigi.</li>
    </ul>
    </li>
</ul>    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1684";}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
