<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:62:"/home/indojalanja_gmail_com/mobile/themes/miqinew/category.dwt";i:1;s:72:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/goods_list.lbi";i:2;s:73:"/home/indojalanja_gmail_com/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1434040519;s:8:"maketime";i:1434036919;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>XL_Popok_Perlengkapan Baby_Tempat Belanja Susu dan Popok Bayi Online Terlengkap | Jalanja Touch Screen</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=163&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">Standard</a> </li>
      <li class=""> <a href="category.php?category=163&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list"><i class="f-ico-arrow-d"></i>Review</a> </li>
      <li class=""> <a href="category.php?category=163&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC#goods_list">Sold</a></li>
      <li class=""> <a href="category.php?category=163&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">Price <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="40000|80000">40000&nbsp;-&nbsp;80000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="80000|120000">80000&nbsp;-&nbsp;120000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="120000|160000">120000&nbsp;-&nbsp;160000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="160000|200000">160000&nbsp;-&nbsp;200000</a></li>
                        <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:;">More<i></i></a> </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=163&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
