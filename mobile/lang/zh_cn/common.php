...
$_LANG['y_view_by_mobile'] = '手机版jalanja';
$_LANG['y_invite_friends'] = '邀请好友';
$_LANG['y_add_favourate'] = '加入收藏';
$_LANG['y_add_fail'] = '抱歉，您所使用的浏览器无法完成此操作。\n\n加入收藏失败，请使用Ctrl+D进行添加';
$_LANG['y_follow_us'] = '关注我们';
$_LANG['y_login'] = '登录';
$_LANG['y_register'] = '免费注册';
$_LANG['y_cart_empty'] = '购物袋内还没有商品，赶快选购吧！';
$_LANG['y_more_groupbuy'] = '更多团购';
$_LANG['y_count_groupbuy'] = '人已团购';
$_LANG['y_quick_buy'] = '数量有限下手要快哦';
$_LANG['y_price_promote'] = '特卖价';
$_LANG['y_more'] = '更多';
$_LANG['y_view_recent'] = '您最近浏览过的商品';
$_LANG['y_view_clean'] = '清除浏览历史';
$_LANG['y_all_goods_cat'] = '全部商品分类';
$_LANG['y_delete'] = '删除';
$_LANG['y_count'] = '共计';
$_LANG['y_day'] = '天';
$_LANG['y_hour'] = '时';
...
$_LANG['y_spread'] = '展开';
$_LANG['y_pack_up'] = '收起';
$_LANG['y_list_default'] = '默认';
$_LANG['y_list_volume'] = '销量';
$_LANG['y_list_price'] = '价格';
$_LANG['y_list_new'] = '新品';
$_LANG['y_a_piece'] = '件';
$_LANG['y_login_msg'] = '欢迎您，请登录';
$_LANG['y_login_no_account'] = '还没有本站账户？';
$_LANG['y_register_now'] = '立即注册';
$_LANG['y_register_msg'] = '欢迎加入Jalanja';
$_LANG['y_has_account'] = '如果您已有本站账户，';
$_LANG['y_login_now'] = '立即登录';
$_LANG['y_register_agree'] = '同意以下协议并注册';
$_LANG['y_order_center'] = '订单中心';
$_LANG['y_user_center'] = '会员中心';
$_LANG['y_account_center'] = '账户中心';

/* author:yuanjiang / email:932625974@qq.com / date:03.23.2015 */
$_LANG['y_count_buy'] = '人已购买';
$_LANG['y_saving'] = '节&nbsp;&nbsp;&nbsp;省';
$_LANG['y_discount'] = '折';
$_LANG['y_sold'] = '已售出';
$_LANG['y_favour_goods'] = '收藏该商品';
$_LANG['y_goods_attr'] = '商品属性';
$_LANG['y_goods_detail'] = '本单详情';
$_LANG['y_goods_photo'] = '产品实拍';
$_LANG['y_goods_comments'] = '买家评论';
$_LANG['y_our_advantage'] = '我们的优势';
$_LANG['y_to_brand'] = '进入品牌专柜';
$_LANG['y_share_to'] = '分享到';
$_LANG['y_praise_degree'] = '好评度';
$_LANG['y_praise_a'] = '好评';
$_LANG['y_praise_b'] = '中评';
$_LANG['y_praise_c'] = '差评';
$_LANG['y_bought'] = '购买过';
$_LANG['y_bought_comment'] = '的顾客，在收到商品后才可以对该商品发表评论';
$_LANG['y_cate_sales_charts'] = '同类热销排行';
$_LANG['y_brand_promote'] = '同品牌产品推荐';
$_LANG['y_hot_sales_charts'] = '热销排行';
$_LANG['y_promote_sales_charts'] = '推荐排行';
$_LANG['y_comment_now'] = '我要评价';
$_LANG['y_to_cart_success'] = '宝贝已成功添加到购物车！';
$_LANG['y_cart_has'] = '购物车共有';
$_LANG['y_cart_count'] = '种宝贝';
$_LANG['y_total'] = '合计';
$_LANG['y_to_cart_settle'] = '去购物袋结算';

/* author:yuanjiang / email:932625974@qq.com / date:03.23.2015 */
$_LANG['y_submit_payinfo'] = '提交支付信息';
$_LANG['y_edit_payinfo'] = '修改支付信息';
$_LANG['y_view_payinfo'] = '查看支付信息';
$_LANG['y_pay_amount'] = '付款金额';
$_LANG['y_pay_time'] = '付款时间';
$_LANG['y_pay_bank'] = '付款银行';
$_LANG['y_pay_account'] = '付款账号';
$_LANG['y_payee_bank'] = '收款银行';
$_LANG['y_select_bank'] = '请选择一个收款银行';
$_LANG['y_note'] = '备注信息';
$_LANG['y_fill_in'] = '请填写';
$_LANG['y_verify_error'] = '审核失败';

/* author:yuanjaing / email:932625974@qq.com / date:03.24.2015 */
$_LANG['y_match'] = '推荐搭配';
$_LANG['y_match_basic'] = '套餐基本件';
$_LANG['y_match_saving'] = '搭配省';
$_LANG['y_match_price'] = '套餐价';
$_LANG['y_match_buy'] = '组合购买';
$_LANG['y_confirm'] = '确定';
$_LANG['y_match_basic_select'] = '请选择套餐基本件';
$_LANG['y_match_select'] = '请选择套餐商品';
$_LANG['y_number_format_error'] = '数据格式不正确';
$_LANG['y_stock_error'] = '库存不足，请选择其他商品';
$_LANG['y_match_saving_amount'] = '搭配买共省';
$_LANG['y_service'] = '客服';
$_LANG['y_to_top'] = '回顶部';
$_LANG['y_cart'] = '购物袋';
$_LANG['y_cart_clean'] = '清空购物车';
$_LANG['y_today_promote'] = '今日特卖精品';
$_LANG['y_today_shipping_free'] = '单笔订单满两件包邮哦';

/* author:yuanjiang / email:932625974@qq.com / date:03.24.2015 */
$_LANG['y_submit_comment'] = '发表评论';
$_LANG['y_goods_score'] = '商品评分';
$_LANG['y_score_star'] = '请点击星星进行打分';
$_LANG['y_comment_all'] = '所有用户都可以对该商品发表评论';
$_LANG['y_comment_login'] = '只有登陆的用户才可以对该商品发表评论';
$_LANG['y_comment_buy_other'] = '在本站购买过一次其他商品的用户才可以对该商品发表评论';
$_LANG['y_goods_score_null'] = '请选择评分等级';

/* author:yuanjiang / email:932625974@qq.com / date:03.26.2015 */
$_LANG['y_user_please_login'] = '老用户，请登录';
$_LANG['y_please_register'] = '新用户，请注册';

/* author:yuanjiang / email:932625974@qq.com / date:03.26.2015 */
$_LANG['y_edit_success'] = '修改成功，请等待审核！';
$_LANG['y_edit_fail'] = '错误：更新数据库失败！';
$_LANG['y_submit_success'] = '提交成功，请等待审核！';
$_LANG['y_submit_fail'] = '错误：插入数据库失败！';
$_LANG['y_ordersn_error'] = '错误：订单号不是你的合法订单号！';
$_LANG['y_ordersn_no_exist'] = '错误：订单号不存在！';

/* author:liju / email:alexliju2@gmail.com / date:05.18.2015 */
$_LANG['article_detail'] = '文章详情';
$_LANG['contact_us'] = '联系我们';
$_LANG['about_us'] = '关于alex';
$_LANG['hot_line'] = '咨询热线';
$_LANG['touch_version'] = '触屏版';
$_LANG['social_login'] = '合作账号登录';
$_LANG['a_input_tlp'] = '请输入电话号码';
$_LANG['a_input_accpwd'] = '请输入账号密码';
$_LANG['a_input_captha'] = '请输入验证码';
$_LANG['a_get_tlp_code'] = '获取手机验证码';
$_LANG['a_next_step'] = '下一步';
?>