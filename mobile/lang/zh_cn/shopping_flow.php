...
$_LANG['no_goods_in_cart'] = "您的购物车中没有商品,去选购吧";
...
$_LANG['bonus_is_ok'] = '该红包序列号可以使用，可以抵扣 %s';
 ...
 /* author,alex,alexliju2@gmail.com */

$_LANG['shopping_myship'] = '我的配送';
$_LANG['shopping_activity'] = '活动列表';
$_LANG['shopping_package'] = '超值礼包列表';
$_LANG['cart_detail'] = '购物车详情';
$_LANG['confirm_order'] = '确认订单';
$_LANG['order_success'] = '提交成功';
$_LANG['go_shopping'] = '去购物';
$_LANG['not_selected'] = '未选择';
?>
