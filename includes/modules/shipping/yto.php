...
class yto
{
    ...
    function query($invoice_sn)
    {
        ...
        $str = '<form style="margin:0px" methods="post" '.
            ...
            '<div class="as-track-button" data-slug="jne" data-tracking-number= "' .$invoice_sn.'" data-counter="true" data-support="true" data-width="200" data-size="small">
            </div>'.
            '</form>';
        return $str;
    }
