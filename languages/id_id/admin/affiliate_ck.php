...
$_LANG['affiliate_separate'] = 'Gainshared';
...
$_LANG['separate_info'] = 'Order No. %s, Gainshared: money %s points %s';
$_LANG['separate_info2'] = 'User ID %s (%s), Gainshared: money %s points %s';
...
$_LANG['sch_stats'][1] = 'Has been Gainshared';
$_LANG['sch_stats'][2] = 'Cancel Gainshare';
...
$_LANG['loginfo']['cancel'] = 'Gainshare by the administrator canceled!';

$_LANG['separate_type'] = 'Gainshare types';
$_LANG['separate_by'][0] = 'Recommend register is gainshare';
$_LANG['separate_by'][1] = 'Recommend orders into';
$_LANG['separate_by'][-1] = 'Recommend register is gainshare';
