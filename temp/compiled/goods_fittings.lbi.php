...
?> 
        ...
        <h2 class=><?php echo $this->_var['lang']['y_match']; ?><?php echo $this->_var['comboTab'][$this->_var['key']]; ?></h2>
        <?php else: ?>
        <h2 class="h2bg"><?php echo $this->_var['lang']['y_match']; ?><?php echo $this->_var['comboTab'][$this->_var['key']]; ?></h2>
        <?php endif; ?> 
            ...
            <tr>
              ...
              <div class="p-name">
               <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"> <?php echo sub_str($this->_var['goods']['goods_name'],28); ?></a>
                ...
                <font class="p-price"><strong class="m_goods_<?php echo $this->_var['key']; ?>_display"><?php echo $this->_var['goods']['shop_price']; ?></strong></font><br />
                <?php echo $this->_var['lang']['y_match_basic']; ?>
...
?> 
              ...
              <div class="p-name"> <a href="<?php echo $this->_var['goods_list']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_list']['goods_name']); ?>"> <?php echo sub_str($this->_var['goods_list']['goods_name'],28); ?></a></div>
                ...
                <font class="p-price"><strong class="m_goods_<?php echo $this->_var['key']; ?>_display"><?php echo $this->_var['goods_list']['fittings_price_ori']; ?></strong></font><br />
                <?php echo $this->_var['lang']['y_match_saving']; ?><?php echo $this->_var['goods_list']['spare_price']; ?>
                </td>
              <?php endif; ?>
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              <td>&nbsp;</td>
          ...
          <div class="infos">
              ...
              <p class="tip_spare"><?php echo $this->_var['lang']['y_match_saving_amount']; ?><strong style="miqi_priceNum">0.00</strong></p>
               <p><?php echo $this->_var['lang']['y_match_price']; ?>：<span class="combo_price">0.00</span> × <input type="text" class="combo_stock" name="m_goods_<?php echo $this->_var['key']; ?>_number" value="1" size="1" style="text-align:center" /></p>
              </div>
             <p class="buy_btn"><a href="javascript:addMultiToCart('m_goods_<?php echo $this->_var['key']; ?>', '<?php echo $this->_var['goods']['goods_id']; ?>')"> <?php echo $this->_var['lang']['y_match_buy']; ?></a></p>
          </div>
        </form>
      </blockquote>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
var btn_buy = "<?php echo $this->_var['lang']['y_confirm']; ?>";
var is_cancel = "<?php echo $this->_var['lang']['is_cancel']; ?>";
var select_spe = "<?php echo $this->_var['lang']['select_spe']; ?>";
var select_base = '<?php echo $this->_var['lang']['y_match_basic_select']; ?>';
var select_shop = '<?php echo $this->_var['lang']['y_match_select']; ?>';
var data_not_complete = '<?php echo $this->_var['lang']['y_number_format_error']; ?>';
var understock = '<?php echo $this->_var['lang']['y_stock_error']; ?>';
