...
<div class="searchRight_title">
  ...
  <div class="rightTitle_right">
    <dl>
      <dd><?php echo $this->_var['lang']['y_count']; ?> <?php echo $this->_var['pager']['record_count']; ?> <?php echo $this->_var['lang']['y_a_piece']; ?></dd>
      
      <?php if ($this->_var['pager']['page_prev']): ?>
      <dt class="rightTitle_prev"><a   class="activity_prev" href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a></dt>
      <?php endif; ?> 
      
      <?php if ($this->_var['pager']['page_next']): ?>
      <dt class="rightTitle_next"><a class="activity_next" href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a></dt>
      <?php endif; ?>
...
?> 
	  ...
	  <div class="sucess_joinCart" id="addtocartdialog_retui_<?php echo $this->_var['goods']['goods_id']; ?>_hot" style="top:65px"></div>
        ...
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(<?php echo $this->_var['goods']['goods_id']; ?>,1,'hot')" href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="join_cart"><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="y_collect"> <span class="y_collectIcon"></span><?php echo $this->_var['lang']['y_favour_goods']; ?> </a> </p>
          </div>
        </div>
      </div>
      </li>
