<div class="content_white" id="lookedList">
  <div class="contentBody">
    <div class="white_title"> <b><?php echo $this->_var['lang']['y_view_recent']; ?></b>
      <p id="clear_btn"><a href="javascript:void(0);" onclick="clear_history();"><?php echo $this->_var['lang']['y_view_clean']; ?></a></p>
    </div>
