...
?>
         ...
         <a class="pinkbtn" style="*line-height: 19px;_line-height: 16px;" href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a>
 ...
 <div class="buytab_a clearfix " >
    <div class="buytab clearfix">
    <div id="tabnavs">
     <h2 class="nstep1_tit2"><?php echo $this->_var['lang']['y_today_promote']; ?><span>(<?php echo $this->_var['lang']['y_today_shipping_free']; ?>)</span></h2>
     </div>
       <div class="buylist2">
       <ul class="other-teambuy">
...
?>
           ...
           <div class="hde">
                ...
                <div  style="clear:both"></div>
         <a class="pinkbtn" style="*line-height: 19px;_line-height: 16px;" href="javascript:addToCartShowDiv(<?php echo $this->_var['goods']['id']; ?>,1,'best')" ><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a>
     ...
     <Div style="width:948px;border:1px #fb9b00 solid;margin:5px auto 0 auto; background:#fff9dd; ">
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            ...
            <input type="submit" class="orderconfirmBtn" value="&nbsp;" />          
            </div>
            </div>
    </div>
    <div class="blank5"></div>
	...
	<img src="themes/miqinew/images/step2.gif" width="980" height="31"/>
        ...
        <div class="content_login ">
            ...
            <div class="coLogin_title">
                        <p><span><?php echo $this->_var['lang']['y_please_register']; ?></span></p>
                    </div>
          ...
          <div class="coLoginBody_right">
           <div class="coLogin_title">
                        <p><span><?php echo $this->_var['lang']['y_user_please_login']; ?></span></p>
                    </div>
            ...
            <input type="checkbox" value="1" name="remember" id="remember"  class="checkbox_txt"/> <label for="remember"><?php echo $this->_var['lang']['remember']; ?></label>
                   ...
                   <a href="user.php?act=qpassword_name" ><?php echo $this->_var['lang']['get_password_by_question']; ?></a><br><a href="user.php?act=get_password" ><?php echo $this->_var['lang']['get_password_by_mail']; ?></a>
                  </div>
                   <div class="coLogin_one">
              ...
              <div class="coLogin_right" style="display:none">
                        <p>您也可以使用合作网站帐户登录</p>
                        <ul>
