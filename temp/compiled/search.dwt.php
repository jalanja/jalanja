...
<div class="search_title ">
      ...
      <div class="title_right"> <a href="index.php"><?php echo $this->_var['lang']['back_home']; ?> &gt;</a> </div>
    </div>
     ...
     <div class="">
      <h5 style="padding:0;">
        ...
        <?php if ($this->_var['intromode'] == 'best'): ?>
         <span class="f5"><?php echo $this->_var['lang']['best_goods']; ?></span>
         <?php elseif ($this->_var['intromode'] == 'new'): ?>
         <span class="f5"><?php echo $this->_var['lang']['new_goods']; ?></span>
         <?php elseif ($this->_var['intromode'] == 'hot'): ?>
         <span class="f5"><?php echo $this->_var['lang']['hot_goods']; ?></span>
         <?php elseif ($this->_var['intromode'] == 'promotion'): ?>
         <span class="f5"><?php echo $this->_var['lang']['promotion_goods']; ?></span>
         <?php else: ?>
         <span class="f5"><?php echo $this->_var['lang']['search_result']; ?></span>
         <?php endif; ?>
        </div> 
