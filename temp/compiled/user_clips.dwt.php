...
<?php echo $this->smarty_insert_scripts(array('files'=>'transport.js,common.js,user.js,ZeroClipboard.js')); ?>
...
<script type="text/javascript">
function showt1() {
document.getElementById("invite1").style.display = "";
document.getElementById("invite2").style.display = "none";
document.getElementById("invite3").style.display = "none";
document.getElementById("invite4").style.display = "none";
}
function showt2() {
document.getElementById("invite1").style.display = "none";
document.getElementById("invite2").style.display = "";
document.getElementById("invite3").style.display = "none";
document.getElementById("invite4").style.display = "none";
}
function showt3() {
document.getElementById("invite1").style.display = "none";
document.getElementById("invite2").style.display = "none";
document.getElementById("invite3").style.display = "";
document.getElementById("invite4").style.display = "none";
}
function showt4() {
document.getElementById("invite1").style.display = "none";
document.getElementById("invite2").style.display = "none";
document.getElementById("invite3").style.display = "none";
document.getElementById("invite4").style.display = "";
}

function check(){
if (document.myfrom.email.value==""){
alert("<?php echo $this->_var['lang']['a_input_email']; ?>");
document.myfrom.email.focus();
return false;
}
if (document.myfrom.text.value==""){
alert("<?php echo $this->_var['lang']['a_invitation_content']; ?>");
document.myfrom.text.focus();
return false;
}
if (document.myfrom.name.value==""){
alert("<?php echo $this->_var['lang']['a_signature']; ?>");
...
<div class="blank"></div>
<h5><span><?php echo $this->_var['lang']['a_invitation_method']; ?></span></h5>
<div class="invite">
<div class="explain"><?php echo $this->_var['lang']['a_to_friend']; ?>:</div>
<div class="function">
<img src="themes/miqinew/images/fx_link.gif" onclick="javascript:showt1();" />
<img src="themes/miqinew/images/fx_email.gif" onclick="javascript:showt2();" />
<img src="themes/miqinew/images/fx_share.gif" onclick="javascript:showt3();" />
<img src="themes/miqinew/images/fx_signature.gif" onclick="javascript:showt4();" />
</div>
<table id="invite1" style="display:none;">
<tr>
<td>
<?php echo $this->_var['lang']['a_share_im']; ?>
<div class="invite1">
<?php echo $this->_var['lang']['a_copy_paste']; ?>
<table width="100%" border="0" cellpadding="0">
<tbody>
<tr>
<td width="90%" height="39"><?php echo $this->_var['lang']['a_link']; ?>:<input style="border:1px solid #C3C3C3; width:378px;" value="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" size="70" type="text"></td>
<td width="10%"><input id="showt1" name="image" src="themes/miqinew/images/fzdi.gif" data-clipboard-target="showt1_text" type="image"></td>
<textarea style="display:none;" id="showt1_text"><?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?> <?php echo $this->_var['lang']['a_share_content']; ?></textarea>
</tr>
</tbody>
</table>
</div>
...
<table id="invite2" style="display:none;">
<tr>
<td align="left" valign="top" bgcolor="#FFFFFF">
<form action="user.php" name="myfrom" method="post" onSubmit="return check();">
<table width="100%" border="0" cellpadding="3">
<tr>
<td>&nbsp;</td>
<td>
<?php echo $this->_var['lang']['a_input_friend_email']; ?><br />
  </td>
</tr>
<tr>
<td align="right" valign="top"><?php echo $this->_var['lang']['email']; ?>：</td>
<td><textarea name="email" cols="70" rows="4" wrap="virtual" class="B_blue"></textarea></td>
</tr>
<tr>
<td align="right" valign="top"><?php echo $this->_var['lang']['comment_content']; ?>:</td>
<td><textarea name="text" cols="70" rows="4" class="B_blue"><?php echo $this->_var['lang']['a_email_content']; ?></textarea></td>
</tr>
<tr>
<td align="right"><?php echo $this->_var['lang']['a_signature']; ?>:</td>
<td><input name="name" type="text" size="40" class="inputBg" /></td>
</tr>
<tr align="center">
<td colspan="2">
<input name="submit" type="submit" class="button" value="<?php echo $this->_var['lang']['a_send']; ?>" />
<input name="reset" type="reset" class="button" value="<?php echo $this->_var['lang']['submit_reset']; ?>" />
<input type="hidden" name="act" value="sendmail_act">
</td>
</tr>
</table>
</form>  
...
<table id="invite3" style="display:none;">
<tr>
<td>
<?php echo $this->_var['lang']['a_share_social']; ?>
<div class="invite3">
...
<table id="invite4" style="display:none;">
<tr>
<td>
<?php echo $this->_var['lang']['a_input_signature']; ?>
<div class="invite4">
...
<td><input size="40" onclick="this.select();" type="text" value="&lt;a href=&quot;<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>&quot; target=&quot;_blank&quot;&gt;<?php echo $this->_var['shopname']; ?>&lt;/a&gt;" /> <?php echo $this->_var['lang']['recommend_webcode']; ?></td>
</tr>
<tr>
...
<td><input size="40" onclick="this.select();" type="text" value="&lt;a href=&quot;<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>&quot; target=&quot;_blank&quot; title=&quot;<?php echo $this->_var['shopname']; ?>&quot;&gt;&lt;img src=&quot;<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>&quot; /&gt;&lt;/a&gt;" /> <?php echo $this->_var['lang']['recommend_webcode']; ?></td>
</tr>
<tr>
<td><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" class="f6"><?php echo $this->_var['shopname']; ?></a></td>
<td><input size="40" onclick="this.select();" type="text" value="[url=<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>]<?php echo $this->_var['shopname']; ?>[/url]" /> <?php echo $this->_var['lang']['recommend_bbscode']; ?></td>
</tr>
<tr>
<td><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" title="<?php echo $this->_var['shopname']; ?>" class="f6"><img src="<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>" /></a></td>
<td><input size="40" onclick="this.select();" type="text" value="[url=<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>][img]<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>[/img][/url]" /> <?php echo $this->_var['lang']['recommend_bbscode']; ?></td>
</tr>
</table>
</div>
</td>
...
<div style="clear:both;"></div>
    ...
    <!-- 下线人数、分成 ,stoped by alex 20150612
    <div class="blank"></div>
...
<!-- /我的推荐清单 stoped by alex 20150612
<div class="blank"></div>
