...
<div class="coLogin_title">
                        <p><span><?php echo $this->_var['lang']['y_login_msg']; ?></span><?php echo $this->_var['lang']['y_login_no_account']; ?> <a href="user.php?act=register"><?php echo $this->_var['lang']['y_register_now']; ?></a></p>
                    </div>
   ...
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        ...
        <div class="coLogin_one">
          ...
          <div class="coLogin_three">
            ...
            <input type="submit" name="submit" value="<?php echo $this->_var['lang']['y_login']; ?>" class="smLogin_btn" />
           
          </div>
	  <div class="coLogin_one">
    
      <a href="user.php?act=qpassword_name" ><?php echo $this->_var['lang']['get_password_by_question']; ?></a><br>
	  <a href="user.php?act=get_password" ><?php echo $this->_var['lang']['get_password_by_mail']; ?></a>
      </div>
...
<div class="coLoginBody">
  <div class="coLogin_title">
                        <p><span><?php echo $this->_var['lang']['y_register_msg']; ?></span><?php echo $this->_var['lang']['y_has_account']; ?><a href="user.php?act=login"><?php echo $this->_var['lang']['y_login_now']; ?></a></p>
                    </div>
                    <div class="coLogin_box" style="width: 582px;margin: 0 0 0 73px;">
    <form action="user.php" method="post" name="formUser" onsubmit="return register();">
       ...
       <div class="coLogin_one">
          <p><?php echo $this->_var['lang']['label_password_intensity']; ?>：</p>
                ...
                <div class="pwd" id="pwd_lower" style="padding:0 30px;"><?php echo $this->_var['lang']['pwd_lower']; ?></div>
                 <div class="pwd" id="pwd_middle" style="padding:0 30px;" ><?php echo $this->_var['lang']['pwd_middle']; ?></div>
                 <div class="pwd" id="pwd_high" style="padding:0 30px;"><?php echo $this->_var['lang']['pwd_high']; ?></div>
      ...
      <?php endif; ?>
        <div class="coLogin_two">
         ...
         <div class="coLogin_three">
          ...
          <input type="hidden" name="back_act" value="<?php echo $this->_var['back_act']; ?>" />
          <input name="Submit" type="submit" value="<?php echo $this->_var['lang']['y_register_agree']; ?>" class="biLogin_btn">
