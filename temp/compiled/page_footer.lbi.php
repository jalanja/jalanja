...
?>
  <ul>
    <li  class="foot_help foot_help_<?php echo $this->_foreach['no']['iteration']; ?> "><a href='<?php echo $this->_var['lang']['y_global_url']; ?><?php echo $this->_var['help_cat']['cat_id']; ?>' title="<?php echo $this->_var['help_cat']['cat_name']; ?>"><?php echo $this->_var['help_cat']['cat_name']; ?></a></li>
    <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
    <li><a href="<?php echo $this->_var['lang']['y_global_url']; ?><?php echo $this->_var['item']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item']['title']); ?>"><?php echo $this->_var['item']['short_title']; ?></a></li>
...
<div id="bottomNav" class="box" style="display:none">
  <div class="bNavList clearfix">
    <div class="f_l"> 
      ...
      <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_63627900_1434346292');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_63627900_1434346292']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
      <a href="<?php echo $this->_var['nav_0_63627900_1434346292']['url']; ?>" <?php if ($this->_var['nav_0_63627900_1434346292']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_63627900_1434346292']['name']; ?></a> 
...
?> 
    ...
    <?php endif; ?>
    <div align="left"  id="rss"><a href="<?php echo $this->_var['lang']['y_global_url']; ?><?php echo $this->_var['feed_url']; ?>"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
<div id="topcontrol" style="width:60px;">
  <div class="nreturn"> 
  <a target="_blank" id="sider_talkonline" href="<?php echo $this->_var['lang']['y_ssl_url']; ?>flow.php" class="ntel buy" style="display: block;"><?php echo $this->_var['lang']['y_cart']; ?></a>
  <a id="sider_talkonline" href="#" onclick="openWin()" class="ntel kf " style="display: block;"><?php echo $this->_var['lang']['y_service']; ?></a> 
    <script>
        function openWin()
        {
  ...
  <a id="sider_addmark" href="javascript:void(0);" onclick="AddFavorite('Favourate',location.href)" class="ntel sider_addmark" style="display: block;"><?php echo $this->_var['lang']['y_add_favourate']; ?></a> 
  <a id="sider_returntop" href="javascript:void(0);" class="ntel sider_returntop" style="display: block;"><?php echo $this->_var['lang']['y_to_top']; ?></a> </div>
</div>
<script>
$(function(){
	isIe6 = false;
