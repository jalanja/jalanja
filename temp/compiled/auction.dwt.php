...
<div class="block clearfix">
  ...
  <div class="AreaR">
   ...
   <div class="box">
   <div class="box_1">
    <h5><span><?php echo $this->_var['lang']['auction_goods_info']; ?></span></h5>
    <div class="boxCenterList">
      ...
      <?php echo $this->_var['lang']['act_time']; ?>：<?php echo $this->_var['auction']['start_time']; ?> -- <?php echo $this->_var['auction']['end_time']; ?><br>
   ...
   <div class="box">
   <div class="box_1">
    <h5><span><?php echo $this->_var['lang']['activity_intro']; ?></span></h5>
    <div class="boxCenterList">
   ...
   <div class="box">
   <div class="box_1">
    <h5><span><?php echo $this->_var['lang']['bid_record']; ?></span></h5>
    <div class="boxCenterList">
