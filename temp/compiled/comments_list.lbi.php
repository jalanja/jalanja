       ...
       <div id="pagebar" class="f_r">
        ...
        <div id="pager">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_96999200_1434363232');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_96999200_1434363232']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_96999200_1434363232']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_97020600_1434363232');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_97020600_1434363232']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_97020600_1434363232']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_97042700_1434363232');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_97042700_1434363232']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_97042700_1434363232']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<div id="boxOverlay"></div>
      ...
      <div class="i-zixun" id="commentform">
              <h3><p><?php echo $this->_var['lang']['y_submit_comment']; ?></p><span class="close"></span></h3>
             <form id="commentForm" name="commentForm" method="post" onsubmit="submitComment(this)" action="javascript:;">
                <table cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr class="tr1">
                    <td class="td1"><?php echo $this->_var['lang']['y_goods_score']; ?>：</td>
                    <td>
                      <div class="cmtRank">
                      ...
                      <span id="Rank"></span>
                      <span><?php echo $this->_var['lang']['y_score_start']; ?></span>
                    </td>
                  ...
                  <tr><td class="td1"><?php echo $this->_var['lang']['goods_comment']; ?>：</td><td><textarea onblur="if(this.value=='') this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue) this.value='';" name="content"><?php if ($this->_var['factor'] == 0): ?><?php echo $this->_var['lang']['y_comment_all']; ?><?php elseif ($this->_var['factor'] == 1): ?><?php echo $this->_var['lang']['y_comment_login']; ?><?php elseif ($this->_var['factor'] == 2): ?><?php echo $this->_var['lang']['y_comment_buy_other']; ?><?php elseif ($this->_var['factor'] == 3): ?><?php echo $this->_var['lang']['y_bought']; ?><?php echo $this->_var['goods_name']; ?><?php echo $this->_var['lang']['y_bought_comment']; ?><?php endif; ?></textarea></td></tr>
                  ...
                  <tr>
					...
					<td>
					 <?php if ($this->_var['enabled_captcha']): ?>
					  ...
					  <?php echo $this->_var['lang']['comment_captcha']; ?>：<input type="text" tabindex="0" name="captcha" value="" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue;" class="text1">	
					  <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" onClick="this.src='captcha.php?'+Math.random()" class="captcha">		  
					  </div>
					 <?php endif; ?>
					 <input type="submit" value="" class="sub" style="margin-left:0">
					</td>
                  </tr>
                </tbody></table>
              </form>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_97083000_1434363232');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_97083000_1434363232']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_97083000_1434363232']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
function submitComment(frm)
{
  ...
  if(cmt.rank <= 0)
  {
		alert('<?php echo $this->_var['lang']['y_goods_score_null']; ?>');
		return false;  
  }
  /*zhou edit end*/
/*
