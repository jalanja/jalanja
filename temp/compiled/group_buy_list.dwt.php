	...
	setInterval(function(){
      $(".end_date").each(function(){
        ...
        if(parseInt(myS+myM+myH+myD) > 0){
			if(show_day == 'show')
			{
				var str = '<?php echo $this->_var['lang']['a_only']; ?><strong class="tcd-d">'+myD+'</strong><?php echo $this->_var['lang']['day']; ?><strong class="tcd-h">'+myH_show+'</strong><?php echo $this->_var['lang']['hour']; ?><strong class="tcd-m">'+myM+'</strong><?php echo $this->_var['lang']['minute']; ?><strong class="tcd-s">'+myS+'</strong><?php echo $this->_var['lang']['y_second']; ?>';
				//var str = '<?php echo $this->_var['lang']['a_only']; ?><strong class="tcd-d">'+myD+'</strong><?php echo $this->_var['lang']['day']; ?><strong class="tcd-h">'+myH_show+'</strong><?php echo $this->_var['lang']['hour']; ?><strong class="tcd-m">'+myM+'</strong><?php echo $this->_var['lang']['minute']; ?><strong class="tcd-s">'+myS+'</strong><?php echo $this->_var['lang']['y_second']; ?>';
			}
			else
			{
				var str = '<span class="times">'+myHZero+myH+'</span><em><?php echo $this->_var['lang']['hour']; ?></em><span class="times">'+myMZero+myM+'</span><em><?php echo $this->_var['lang']['minute']; ?></em><span class="times">'+mySZero+myS+'</span><em><?php echo $this->_var['lang']['y_second']; ?></em>';
			}
        }else{
			var str = "<?php echo $this->_var['lang']['gbs_finished']; ?>";	
		}
		obj.html(str);
      });
    }, 100);	
...
?> 
            ...
            <li class="big_list clearfix" >
              <div id="deal-title" style="padding-bottom:20px;">
                <h1><span><?php echo $this->_var['lang']['group_buy']; ?>: </span></h1>
              ...
              <div id="deal_info" style="border-right:1px solid #e5e5e5; width:222px; height:350px;">
                <div class="ribbon ribbon_1">
                  ...
                  <div class="price">
                    <table>
                      <tbody>
                        <tr>
                          <th class="market_price"><?php echo $this->_var['lang']['market_price']; ?></th>
                          <th class="discount"><?php echo $this->_var['lang']['discount']; ?></th>
                          <th><?php echo $this->_var['lang']['y_saving']; ?></th>
                        </tr>
                        <tr>
                          <td class="market_price"><span class="arial">Rp</span><?php echo $this->_var['group_buy']['market_price']; ?></td>
                          <td class="ff4560"><?php echo $this->_var['group_buy']['zhekou']; ?>%</td>
                          <td class="ff4560"><span class="arial">Rp</span><?php echo $this->_var['group_buy']['jiesheng']; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div class=" countdown_1 countdown"> <span class="endtime"><?php echo $this->_var['lang']['gb_end_date']; ?></span>
                ...
                <div class="deal_status deal_status_1">
                  <div class="purhcase_number f20 "><span class="ff4560 f24 bold"><?php echo $this->_var['group_buy']['cur_amount']; ?></span><?php echo $this->_var['lang']['buyer']; ?></div>
                  <div class="progress no_stock_soon"> <?php echo $this->_var['lang']['y_quick_buy']; ?> </div>
                </div>
              </div>
...
?> 
          ...
          <h2 class="multi_tit">
			  ...
			  <table>
                <tbody>
				  <tr>
                    <td><?php echo $this->_var['lang']['market_price']; ?></td>
                    <td><?php echo $this->_var['lang']['discount']; ?></td>
                    <td><?php echo $this->_var['lang']['y_saving']; ?></td>
                  </tr>
                  <tr>
                    ...
                    <td class="pcred"><span class="arial">Rp</span><?php echo $this->_var['group_buy']['jiesheng']; ?></td>
                  </tr>
                </tbody>
		      </table>
			  <a class="multi_btn" href="<?php echo $this->_var['group_buy']['url']; ?>" target="_blank"></a>
			  <div class="multi_pc wei"><span class="arial f20">Rp</span><?php echo $this->_var['group_buy']['price_ladder']['0']['price']; ?></div>
			</div>
