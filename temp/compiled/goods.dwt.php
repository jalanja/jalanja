...
?> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width"><?php echo $this->_var['lang']['market_price']; ?></span>：<?php echo $this->_var['goods']['market_price']; ?> 
                    <?php endif; ?> 
                  </p>
                   
				  <?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?> 
                  <?php echo $this->smarty_insert_scripts(array('files'=>'lefttime.js')); ?>
                  <p><b><i class="goods_attr_width"><?php echo $this->_var['lang']['promote_price']; ?></i>：<font><?php echo $this->_var['goods']['promote_price']; ?></font></b></p>
                  <p><b><i class="goods_attr_width"><?php echo $this->_var['lang']['residual_time']; ?></i>：<font  id="leftTime"><?php echo $this->_var['lang']['please_waiting']; ?></font></b></p>
                  <?php else: ?>
                  <b><i class="goods_attr_width"><?php echo $this->_var['lang']['shop_price']; ?></i>：<font  id="ECS_SHOPPRICE"><?php echo $this->_var['goods']['shop_price_formated']; ?></font></b>
                  <?php endif; ?>
...
?> 
                  ...
                  <p><i class="goods_attr_width"><?php echo $this->_var['lang']['y_saving']; ?></i>：<?php echo $this->_var['goods']['jiesheng']; ?>（<?php echo $this->_var['goods']['zhekou']; ?><?php echo $this->_var['lang']['y_discount']; ?>）</p>
                <!--  <p><i class="goods_attr_width"><?php echo $this->_var['lang']['y_sold']; ?></i>： <span style="color: #4c4c4c;"><?php echo $this->_var['goods']['sales_count']; ?> <?php echo $this->_var['lang']['y_a_piece']; ?></span></p> -->
...
?>
				  ...
				  <p>
                   <i class="goods_attr_width"><?php echo $this->_var['lang']['goods_give_integral']; ?></i>：<font class="f4"><?php echo $this->_var['goods']['give_integral']; ?> <?php echo $this->_var['points_name']; ?></font> 
                  </p>
				  <?php endif; ?>                
              ...
              <div class="center_txt clearfix"> 
                ...
                <p><strong><?php echo $this->_var['lang']['goods_integral']; ?></strong>：<font class="f4"><?php echo $this->_var['goods']['integral']; ?> <?php echo $this->_var['points_name']; ?></font></p>
                <?php endif; ?> 
...
?>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(<?php echo $this->_var['goods']['goods_id']; ?>)" <?php if ($this->_var['goods']['goods_number'] == 0): ?>class="sold_out"<?php endif; ?>></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['lang']['y_favour_goods']; ?></a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                  ...
                  <p><a href="user.php?act=affiliate&goodsid=<?php echo $this->_var['goods']['goods_id']; ?>">klik sini,share and get Rp3,000.</a></p>
                  <?php endif; ?>
            ...
            <div class="detail_logo">
              ...
              <div class="detail_logo_btn"> <a href="<?php echo $this->_var['goods']['goods_brand_url']; ?>" ><?php echo $this->_var['lang']['y_to_brand']; ?></a> </div>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="AreaL" style=" width:275px"> 
       <?php echo $this->fetch('library/goods_related.lbi'); ?>  <?php echo $this->fetch('library/top10_goods.lbi'); ?>  <?php $this->assign('brand_goods',$this->_var['brand_goods_14']); ?><?php $this->assign('goods_brand',$this->_var['goods_brand_14']); ?><?php echo $this->fetch('library/brand_goods.lbi'); ?> 
        <div class=" newStarPro  lshadow"  >
          <div class="ff_1">
            <h2 id="ECS_tree1" class=" tabFront" style=""><?php echo $this->_var['lang']['y_hot_sales_charts']; ?></h2>
            <h2 id="ECS_tree2" class=" tabBack"  style=""><?php echo $this->_var['lang']['y_promote_sales_charts']; ?></h2>
          </div>
          ...
          <DIV class="inDetail_box">
            <div class="fixed_out ">
              <div  id="inner" class="fixed" >
                <ul class="inLeft_btn">
                  <li><a id="property-id" href="#shangpsx" class="current"><?php echo $this->_var['lang']['y_goods_attr']; ?></a></li>
                  <li><a id="detail-id" href="#shangpjs"><?php echo $this->_var['lang']['y_goods_detail']; ?></a></li>
                  <li><a id="shot-id" href="#miqsp"><?php echo $this->_var['lang']['y_goods_photo']; ?></a></li>
                  <li><a id="coms1-id" href="#coms1"><?php echo $this->_var['lang']['y_goods_comments']; ?></a></li>
                  <li class="advantage"><a id="good-id" href="#miqfw"><?php echo $this->_var['lang']['y_our_advantage']; ?></a></li>
                </ul>
              </div>
            </div>
            <script type="text/javascript">
              ...
              <div class="inLeft_attributes" style="margin:0;">
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td><?php echo $this->_var['lang']['goods_name']; ?></td>
...
?>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="rate"> <strong><?php echo $this->_var['comment_percent']['haoping_percent']; ?>%</strong> <br> <?php echo $this->_var['lang']['y_praise_degree']; ?> </div>
                <div class="percent"> 
                  <dl> 
                    <dt><?php echo $this->_var['lang']['y_praise_a']; ?></dt> 
                    <dd class="d1"> 
                  ...
                  <dl> 
                    <dt><?php echo $this->_var['lang']['y_praise_b']; ?></dt> 
                    <dd class="d1"> 
                  ...
                  <dl> 
                    <dt><?php echo $this->_var['lang']['y_praise_c']; ?></dt> 
                    <dd class="d1"> 
                ...
                <div class="btns"> 
                  <div><?php echo $this->_var['lang']['y_bought']; ?><?php echo $this->_var['goods']['goods_name']; ?><?php echo $this->_var['lang']['y_bought_comment']; ?></div> 
                  <a href="javascript:void(0);" class="btn-comment" id="showcommentform"><?php echo $this->_var['lang']['y_comment_now']; ?></a>
                </div>
                <div class="clear"></div>
              </div>
