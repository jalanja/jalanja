...
<dl class="accountSideOption1">
  <dt class="transaction_manage"><?php echo $this->_var['lang']['y_order_center']; ?></dt>
  <dd>
    <ul>
...
<dl class="accountSideOption1">
  <dt class="transaction_manage"><?php echo $this->_var['lang']['y_user_center']; ?></dt>
  <dd>
    <ul>
...
<dl class="accountSideOption1">
  <dt class="transaction_manage"><?php echo $this->_var['lang']['y_account_center']; ?></dt>
  <dd>
    <ul>
