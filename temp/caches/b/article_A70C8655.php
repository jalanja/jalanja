<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:54:"/home/indojalanja_gmail_com/themes/miqinew/article.dwt";i:1;s:66:"/home/indojalanja_gmail_com/themes/miqinew/library/page_header.lbi";i:2;s:62:"/home/indojalanja_gmail_com/themes/miqinew/library/ur_here.lbi";i:3;s:64:"/home/indojalanja_gmail_com/themes/miqinew/library/left_help.lbi";i:4;s:66:"/home/indojalanja_gmail_com/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1434366483;s:8:"maketime";i:1434362883;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="Order status" />
<title>Order Status_Service_Help Center_Info Center_Tempat Belanja Susu dan Popok Bayi Online Terlengkap | Jalanja</title>
...
<div class="block_s">
 <div id="ur_here">
  <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="article_cat-1.html">Info Center</a> <code>&gt;</code> <a href="article_cat-3.html">Help Center</a> <code>&gt;</code> <a href="article_cat-6.html">Service</a> <code>&gt;</code> Order Status
</div>
<div class="blank"></div>
...
<div class="sideMenu" style="margin:0 auto">
			...
			<h2  class="on"><em></em><a  href='article_cat-6.html' title="Service">Service</a></h2>
			<ul style="display:block">
            				<li><a  href="article-12.html" title="Return policy"> Return policy</a></li>
                				<li><a  class="sell"  href="article-41.html" title="Order Status"> Order Status</a></li>
  ...
  <div class="help_right_out">
    <div class="help_right">
         ...
         <p>Order Status</p> <b>Jalanja / 18-03-2015</b>
         </div>
         <div class="blank"></div>
         <div class="content_right">
                   <div style="margin: 0px; padding: 15px 0px; border: none; line-height: 24px; float: left; color: rgb(102, 102, 102); font-family: 微软雅黑, 宋体, Arial, Helvetica, sans-serif; font-size: 12px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);" class="content_list border_none">
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><font><font>Sebuah order baru di jalanja.com dan pesanan selesai,&nbsp; kami akan menunjukkan pesanan bagian di halaman detail pesanan, kami berharap dengan cara ini membuat Anda lebih mengerti berbelanja online, status order pelacakan tepat waktu, menghilangkan rasa khawatir belanja online merupakan kepuasan customer.<span class="Apple-converted-space">&nbsp;</span></font><font>Berikut ini adalah penjelasan singkat dari status order:</font></font></p>
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);">&nbsp;</p>
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span class="sms_text" style="line-height: 23.9999980926514px; padding: 0px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;">Konfirmasi Pesanan:</span><font style="line-height: 23.9999980926514px;">&nbsp;Jika status pesanan anda yang di tampilkan sebagai &quot;Belum Konfirmasi&quot;, maka staff/admin kami belum mengkonfirmasi pesanan anda, apabila pesanan anda telah kami konfirmasi, maka anda akan mendapatkan email dari service@jalanja.com yang berisi konfirmasi pesanan anda dan status pesanan akan berubah menjadi &quot;Telah Dikonfirmasi&quot;.</font></p>
</div>
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Konfirmasi pembayaran:</font></font></span><font><font><span class="Apple-converted-space">&nbsp;</span>Jika Anda memilih untuk membayar saldo, Alipay, kartu kredit pembayaran cepat, online banking, bank transfer.<span class="Apple-converted-space">&nbsp;</span></font><font>Sebelum Anda membayar , status pesanan akan ditampilkan sebagai &quot;Belum Dibayar&quot;.<br />
</font></font></p>
</div>
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Tunggu pengiriman:</font></font></span><font><font><span class="Apple-converted-space">&nbsp;</span>Status Keterangan jalanja.com adalah memilih perintah Anda, kami sarankan membayar sebelum jam 16:00, dan akan dikirim pada hari berikutnya.<span class="Apple-converted-space">&nbsp;</span></font><font>Harap bersabar, setelah status delivery order akan diperbarui.<br />
</font></font></p>
</div>
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Dikirim:</font></font></span><font><font><span class="Apple-converted-space">&nbsp;</span>Pesanan Anda telah dikirimkan barang yang dalam perjalanan.</font></font></p>
</div>
<div style="margin: 0px; padding: 7px 0px;float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Mengkonfirmasi penerimaan:</font></font></span><font><font><span class="Apple-converted-space">&nbsp;</span>barang telah dikeluarkan untuk beberapa waktu, jika Anda telah menerima barang dapat mengklik tombol OK untuk mengkonfirmasi</font></font></p>
</div>
<br />
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Rating:</font></font></span><font><font><span class="Apple-converted-space">&nbsp;</span>Anda harus mengkonfirmasi penerimaan, dan mengelavuasi produk dan layanan kami.</font></font></p>
</div>
</div>
<div style="margin: 0px; padding: 25px 0px; border-top-width: 1px; border-top-color: rgb(230, 230, 230); border-top-style: solid; line-height: 24px; float: left; color: rgb(102, 102, 102); font-family: 微软雅黑, 宋体, Arial, Helvetica, sans-serif; font-size: 12px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);" class="content_list list_top_img">
<h1 style="margin: 0px; padding: 0px; font-size: 18px; font-weight: bold; color: rgb(33, 33, 33);"><font><font>Pesanan FAQ kategori:</font></font></h1>
<div style="margin: 0px; padding: 7px 0px;float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Alamat pengiriman saya mengisi kesalahan, bagaimana memodifikasi?</font></font></span></p>
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><font><font>Jika Anda menghadapi situasi ini, silakan menghubungi Costumer Service Kami untuk memvefikasi alamat pengiriman anda.</font></font></p>
</div>
<div style="margin: 0px; padding: 7px 0px; float: left;" class="sms_txt_03">
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><span style="padding: 0px; font-size: 14px; font-weight: bold; color: rgb(33, 33, 33); font-family: 微软雅黑;" class="sms_text"><font><font>Bagaimana cara membatalkan pesanan?</font></font></span></p>
<p style="margin: 0px; padding: 0px; font-size: 14px; color: rgb(76, 76, 76);"><font><font>Jika pesanan Anda tidak sampai/lama dalam pengiriman, silahkan hubungi customer service untuk membatalkan pesanan Anda, jika Anda telah memnerima pesanan, silakan Konfirmasi Kembali Ke&nbsp;</font></font>customer service kami.</p>
</div>
</div>                            </div>
           <div class="blank"></div>
         <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #e6e6e6 ;">
         
                      Next :<a href="article-43.html" class="f6">Point mall</a><br />
                    
                      Pre:<a href="article-12.html" class="f6">Return policy</a>
                   </div>
