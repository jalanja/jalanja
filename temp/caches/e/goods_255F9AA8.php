...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr">  <a href="images/201504/goods_img/1699_P_1429665246968.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1699'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1699_G_1429665246780.jpg" alt="S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1699_P_1429665246968.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1699_P_1429665246968.jpg"><img src="images/201504/thumb_img/1699_thumb_P_1429665246393.jpg" alt="S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1699)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：10 </p>
                  <p> 
              ...
              <div class="center_txt clearfix"> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1699)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1699)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1699">klik sini,share and get Rp3,000.</a></p>
...
<h2 class="mall_leftTitle c333">Releate Product</h2>
 <ul class="pro_list">
             <li>
        <a href="mamypoko-tipe-standard-L-Universal" class="pro_pic"><img src="images/201504/thumb_img/380_thumb_G_1429650667456.jpg" alt="MamyPoko Pants Standar, Size L, 30pcs"  width="120" height="120"/></a>
        <a href="mamypoko-tipe-standard-L-Universal" title="MamyPoko Pants Standar, Size L, 30pcs" class="pro_title">MamyPoko Pants Standar, Size L, 30pcs</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="mamypoko-tipe-standard-L-Universal">
               <font class="f1">Rp<span>66,000</span></font>
                </a>
        </p>
       </li>
             <li>
        <a href="Goon-Friend-Ekonomis-Pants-L20" class="pro_pic"><img src="images/201504/thumb_img/1636_thumb_G_1429662020978.jpg" alt="Goo.n Pants Friend Ekonomis, Size L, 20pcs"  width="120" height="120"/></a>
        <a href="Goon-Friend-Ekonomis-Pants-L20" title="Goo.n Pants Friend Ekonomis, Size L, 20pcs" class="pro_title">Goo.n Pants Friend Ekonomis, Size L, 20pcs</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="Goon-Friend-Ekonomis-Pants-L20">
               <font class="f1">Rp<span>45,000</span></font>
                </a>
        </p>
       </li>
             <li>
        <a href="Pampers-Tape-Simply-Dry-Ekonomis-L38" class="pro_pic"><img src="images/201504/thumb_img/1639_thumb_G_1430079035088.jpg" alt="Pampers Tape Simply Dry Ekonomis, Size L, 38pcs"  width="120" height="120"/></a>
        <a href="Pampers-Tape-Simply-Dry-Ekonomis-L38" title="Pampers Tape Simply Dry Ekonomis, Size L, 38pcs" class="pro_title">Pampers Tape Simply Dry Ekonomis, Size L, 38pcs</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="Pampers-Tape-Simply-Dry-Ekonomis-L38">
               <font class="f1">Rp<span>71,000</span></font>
                </a>
        </p>
       </li>
          </ul>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1699); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1699); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1699); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1699); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1699_G_1429665246780.jpg" alt="S26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr"  /></td>
                      </tr>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;</p>
<h3>S26 Procal Regular 3</h3>
<p>Usia sampai 3 tahun adalah masa emas yang menentukan perkembangan anak di masa depan. Bantu tumbuh kembangnya dengan memilih susu yang tepat untuk asupan nutrisi terbaik.</p>
<p>S26 Procal adalah susu pertumbuhan dalam bentuk bubuk yang telah diperkaya dengan nutrisi penting untuk pertumbuhan fisik buah hati Anda,</p>
<p>serta energi 200 kalori setiap sajiannya untuk kebutuhannya sehari-hari. S26 Procal ini diformulasikan khusus untuk anak berusia 1-3 tahun.<br />
<br />
<strong>Mengandung Nutrisi, Mineral, &amp; Kalsium</strong></p>
<p><br />
S26 Procal mengandung berbagai nutrisi yang bermanfaat untuk pertumbuhan fisik anak, seperti Omega 3, Omega 6, 5 nukleotida serta vitamin untuk daya tahan tubuhnya.</p>
<p>Kandungan mineral penting seperti zat besi dan kalsium juga terkandung di dalamnya, memberikan anak kebutuhan gizi sempurna sehari-hari.<br />
<br />
<strong>Rasa Lezat</strong></p>
<p><br />
S26 Procal mengerti kebutuhan buah hati Anda, karenanya dibuatlah susu pertumbuhan berbentuk bubuk dengan rasa lezat yang dapat dinikmati oleh anak Anda.</p>
<p>Dengan rasa yang lezat, anak akan meminum susu ini tanpa harus dipaksa. Tumbuh kembang anak terjaga, buah hati Anda pun senang.</p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1699_thumb_G_1429665246252.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspS26 Procal Regular 3, Vanila, 1-3 Tahun, 400gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1699";}554fcae493e564ee0dc75bdf2ebf94ca</div>
