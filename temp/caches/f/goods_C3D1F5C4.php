...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-194-b0.html">Food</a> <code>&gt;</code> <a href="category-198-b0.html">Bubur</a> <code>&gt;</code> Nestle Cerelac Susu Serealia & Sayur-sayuran, 1-2 tahun 120gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Nestle Cerelac Susu Serealia &amp; Sayur-sayuran, 1-2 tahun 120gr">  <a href="images/201505/goods_img/1787_P_1430707181889.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1787'); return false;"><img id="J_prodImg" src="images/201505/goods_img/1787_G_1430707181025.jpg" alt="Nestle Cerelac Susu Serealia &amp; Sayur-sayuran, 1-2 tahun 120gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201505/goods_img/1787_P_1430707181889.jpg" rel="zoom-id: Zoomer" rev="images/201505/goods_img/1787_P_1430707181889.jpg"><img src="images/201505/thumb_img/1787_thumb_P_1430707181621.jpg" alt="Nestle Cerelac Susu Serealia & Sayur-sayuran, 1-2 tahun 120gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1787)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Nestle Cerelac Susu Serealia & Sayur-sayuran, 1-2 tahun 120gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>19,200</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>16,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>3,200</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">16 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">160 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1787)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1787)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1787">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1787); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1787); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1787); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1787); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Nestle Cerelac Susu Serealia & Sayur-sayuran, 1-2 tahun 120gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201505/goods_img/1787_G_1430707181025.jpg" alt="Nestle Cerelac Susu Serealia &amp; Sayur-sayuran, 1-2 tahun 120gr"  /></td>
                      </tr>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><span style="border: 0px none; margin: 0px; padding: 0px;">Bubur  Bayi Nestl&eacute; CERELAC Harga Ekonomis mencukupkan kebutuhan nutrisi si  Kecil. &nbsp;Bubur Bayi Nestl&eacute; CERELAC Susu mempunyai keunggulan kandungan:</span></div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">&nbsp;</div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><span style="border: 0px none; margin: 0px; padding: 0px;">1.  CHE (Carbohydrate Hydrolysed Enzimatically) merupakan teknologi milik  Nestl&eacute; untuk menghidrolisa karbohidrat secara alami dengan menggunakan  proses enzimatis. Manfaat:- Mengoptimalkan kepadatan nutrisi - Tekstur  lembut sehingga memudahkan untuk ditelan, Mudah dicerna sehingga dapat  meningkatkan cita rasa dan rasa manis alami tanpa penambahan sukrosa.&nbsp;</span></div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">&nbsp;</div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><span style="border: 0px none; margin: 0px; padding: 0px;">2.  DHA: Merupakan salah satu nutrisi penting dalam masa pertumbuhan karena  merupakan struktur asam lemak yang dominan pada sistem syaraf dan  retina. Manfaat: Penting untuk otak anak sampai usia 2 tahun&nbsp;</span></div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">&nbsp;</div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><span style="border: 0px none; margin: 0px; padding: 0px;">3.  Probiotik Bifidus BL merupakan bakteri baik dalam jumlah tertentu yang  dapat tetap hidup serta stabil dalam ekosistem usus sehingga bakteri  baik akan tumbuh lebih dominan dalam usus. Manfaat &nbsp;Membantu  mempertahankan fungsi saluran cerna.&nbsp;</span></div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">&nbsp;</div>
<div style="border: 0px; margin: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><span style="border: 0px none; margin: 0px; padding: 0px;">4.  Zat besi, Zink, Vitamin A &amp; C merupakan kombinasi mineral dan  vitamin yang disebut immunonutrient. Manfaat: - Mendukung fungsi  kekebalan tubuh.</span></div>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201505/thumb_img/1787_thumb_G_1430707181320.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspNestle Cerelac Susu Serealia & Sayur-sayuran, 1-2 tahun 120gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1787";}554fcae493e564ee0dc75bdf2ebf94ca</div>
