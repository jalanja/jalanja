...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-154-b0.html">Perlengkapan Baby</a> <code>&gt;</code> <a href="category-152-b0.html">Popok</a> <code>&gt;</code> <a href="category-161-b0.html">M</a> <code>&gt;</code> MamyPoko Pants Standar, Size M, 9pcs </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="MamyPoko Pants Standar, Size M, 9pcs">  <a href="images/201504/goods_img/1717_P_1429648497894.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1717'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1717_G_1429648497913.jpg" alt="MamyPoko Pants Standar, Size M, 9pcs" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1717_P_1429648497894.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1717_P_1429648497894.jpg"><img src="images/201504/thumb_img/1717_thumb_P_1429648497175.jpg" alt="MamyPoko Pants Standar, Size M, 9pcs"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1717)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>MamyPoko Pants Standar, Size M, 9pcs</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：0 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>24,000</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>20,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>4,000</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">20 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">200 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1717)" class="sold_out"></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1717)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1717">klik sini,share and get Rp3,000.</a></p>
...
<h2 class="mall_leftTitle c333">Releate Product</h2>
 <ul class="pro_list">
        ...
        <a href="nutribaby-soya-tahap-2-bersih-400gr-untuk-bayi-6-12-bulan">
             ...
             <li>
        <a href="vidoran-my-baby-2-6-12-bulan-135gr" class="pro_pic"><img src="images/201504/thumb_img/1219_thumb_G_1429671734406.jpg" alt="Vidoran My Baby 2, 6-12 Bulan, 135gr"  width="120" height="120"/></a>
        <a href="vidoran-my-baby-2-6-12-bulan-135gr" title="Vidoran My Baby 2, 6-12 Bulan, 135gr" class="pro_title">Vidoran My Baby 2, 6-12 Bulan, 135gr</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="vidoran-my-baby-2-6-12-bulan-135gr">
               <font class="f1">Rp<span>16,000</span></font>
                </a>
        </p>
       </li>
             <li>
        <a href="Bebelove-2-400" class="pro_pic"><img src="images/201504/thumb_img/1450_thumb_G_1429051480041.jpg" alt="Bebelove 2, 6-12 Bulan, 400gr"  width="120" height="120"/></a>
        <a href="Bebelove-2-400" title="Bebelove 2, 6-12 Bulan, 400gr" class="pro_title">Bebelove 2, 6-12 Bulan, 400gr</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="Bebelove-2-400">
               <font class="f1">Rp<span>68,000</span></font>
                </a>
        </p>
       </li>
          </ul>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1717); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1717); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1717); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1717); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> MamyPoko Pants Standar, Size M, 9pcs</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1717_G_1429648497913.jpg" alt="MamyPoko Pants Standar, Size M, 9pcs"  /></td>
                      </tr>
                      
                       
                                            <tr >
                        <td>Ukuran</td>
                        <td><p class="fit_people ">M</p></td>
                      </tr>
                                            <tr >
                        <td>Tipe</td>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;<img src="/images/upload/Image/mamypoko/pants-standard-1.jpg" width="660" height="990" alt="" /></p>
<p><img src="/images/upload/Image/mamypoko/pants-standard-3.jpg" width="660" height="990" alt="" /></p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1717_thumb_G_1429648497155.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspMamyPoko Pants Standar, Size M, 9pcs&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1717";}554fcae493e564ee0dc75bdf2ebf94ca</div>
