...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-154-b0.html">Perlengkapan Baby</a> <code>&gt;</code> <a href="category-152-b0.html">Popok</a> <code>&gt;</code> <a href="category-156-b0.html">S</a> <code>&gt;</code> MamyPoko Pants Standar, Size S, 40pcs </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="MamyPoko Pants Standar, Size S, 40pcs">  <a href="images/201504/goods_img/388_P_1429650591809.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=388'); return false;"><img id="J_prodImg" src="images/201504/goods_img/388_G_1429650591107.jpg" alt="MamyPoko Pants Standar, Size S, 40pcs" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/388_P_1429650591809.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/388_P_1429650591809.jpg"><img src="images/201504/thumb_img/388_thumb_P_1429650591540.jpg" alt="MamyPoko Pants Standar, Size S, 40pcs"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(388)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>MamyPoko Pants Standar, Size S, 40pcs</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：3 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>76,200</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>63,500</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>12,700</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">63 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">635 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(388)" class="sold_out"></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(388)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=388">klik sini,share and get Rp3,000.</a></p>
...
<h2 class="mall_leftTitle c333">Releate Product</h2>
 <ul class="pro_list">
        ...
        <a href="morinaga-bmt-p-hp-1-0-6-bulan-800gr">
             ...
             <li>
        <a href="Isomil-advance-soya-900gr" class="pro_pic"><img src="images/201504/thumb_img/1634_thumb_G_1429732289999.jpg" alt="Isomil Advance Soya, 0-12 Bulan, 900gr"  width="120" height="120"/></a>
        <a href="Isomil-advance-soya-900gr" title="Isomil Advance Soya, 0-12 Bulan, 900gr" class="pro_title">Isomil Advance Soya, 0-12 Bulan, 900gr</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="Isomil-advance-soya-900gr">
               <font class="f1">Rp<span>261,000</span></font>
                </a>
        </p>
       </li>
             <li>
        <a href="frisian-baby-awal-0-6-bulan-400gr" class="pro_pic"><img src="images/201504/thumb_img/1647_thumb_G_1429665828798.jpg" alt="Frisian Baby Awal, 0-6 Bulan, 400gr"  width="120" height="120"/></a>
        <a href="frisian-baby-awal-0-6-bulan-400gr" title="Frisian Baby Awal, 0-6 Bulan, 400gr" class="pro_title">Frisian Baby Awal, 0-6 Bulan, 400gr</a>
        <p class="already_sold">Sold 0 pcs</p>
        <p class="pro_price">
        <a href="frisian-baby-awal-0-6-bulan-400gr">
               <font class="f1">Rp<span>44,000</span></font>
                </a>
        </p>
       </li>
          </ul>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 388); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 388); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),388); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),388); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> MamyPoko Pants Standar, Size S, 40pcs</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/388_G_1429650591107.jpg" alt="MamyPoko Pants Standar, Size S, 40pcs"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Celana</p></td>
                                            ...
                                            <tr >
                        <td>Isi Kemasan</td>
                        <td><p class="fit_people ">40 pcs</p></td>
                      </tr>
                                            <tr >
                        <td>Produsen</td>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p><img src="/images/upload/Image/20150318140512018_6374851.jpg" width="660" height="990" alt="" /><img src="/images/upload/Image/20150318140517356_68681575.jpg" width="660" height="990" alt="" /></p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/388_thumb_G_1429650591784.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspMamyPoko Pants Standar, Size S, 40pcs&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:3:"388";}554fcae493e564ee0dc75bdf2ebf94ca</div>
