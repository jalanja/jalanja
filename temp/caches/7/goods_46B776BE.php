...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-167-b0.html">6-12 Bulan</a> <code>&gt;</code> S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr">  <a href="images/201504/goods_img/1161_P_1429651562054.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1161'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1161_G_1429651562263.jpg" alt="S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1161_P_1429651562054.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1161_P_1429651562054.jpg"><img src="images/201504/thumb_img/1161_thumb_P_1429651562801.jpg" alt="S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr"></a> </li>
                            <li > <a href="images/201504/goods_img/1161_P_1429650475932.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1161_P_1429650475932.jpg"><img src="images/201504/thumb_img/1161_thumb_P_1429650475421.jpg" alt="S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1161)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：26 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>308,400</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>257,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>51,400</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">36 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">250 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">2500 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1161)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1161)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1161">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1161); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1161); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1161); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1161); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1161_G_1429651562263.jpg" alt="S26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Singapura</p></td>
                      </tr>
                                            <tr >
                        <td>Diproduksi di</td>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <h3>&nbsp;<strong><em style="color: rgb(0, 100, 0);">S26 Promil Gold 900gr.</em></strong></h3>
<p><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;">S26  Promil Gold Tahap 2 merupakan susu formula lanjutan untuk bayi yang  sudah memasuki usia 6-12 bulan, mengandung gizi yang cukup untuk  memenuhi nutrisi pada bayi. Dalam sekaleng susu S26 Promil Gold Tahap 2  mengandung Protein, Karbohidrat,Asam Linoleat, Kalsium, Vitamin, dan  juga Mineral yang dapat mendukung pertumbuhan bagi bayi. Diperkaya  dengan Zat Besi dan Zink untuk mendukung pertumbuhan bayi yang optimal.  Susu formula ini merupakan makanan pendamping dan juga susu pendamping  Air Susu Ibu (ASI) tetapi tidak dapat menjadi pengganti ASI.</span></p>
<p><strong style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;">Mengandung Gizi yang Cukup</strong></p>
<p><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;">S26  Promil Gold Tahap 2 ini khusus dibuat untuk bayi yang sudah memasuki  usia 6-12 bulan sebagai makanan pendamping dan juga susu pendamping ASI,  tetapi tidak dapat menjadi pengganti ASI. Didalamnya mengandung  Protein, karbohidrat,Asam Linoleat, Kalsium, Vitamin, dan juga Mineral  yang dapat mendukung pertumbuhan bagi bayi.</span><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;" />
<br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;" />
<strong style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;">Nutrisi Maksimal</strong><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;" />
<span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.799999237060547px; text-align: justify;">Berikan  susu formula lanjutan secukupnya agar nutrisi bayi tercukupi setiap  harinya. Dengan rasa vanilla yang disukai oleh si kecil, S26 Promil Gold  Tahap 2 tersedia dalam kemasan kaleng ukuran 900gr untuk setiap  paketnya. Penggunaan susu formula ini hanya boleh digunakan kepada bayi  atas petunjuk dokter atau ahli kesehatan anak. Berikan segala kebaikan  untuk si kecil karena ia adalah segalanya bagi ibu.</span></p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1161_thumb_G_1429651562210.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspS26 Promil Gold 2, Vanila, 6-12 Bulan, 900gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1161";}554fcae493e564ee0dc75bdf2ebf94ca</div>
