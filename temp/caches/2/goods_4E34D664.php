...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> Dancow Datita, Madu, 3-5 Tahun, 500gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Dancow Datita, Madu, 3-5 Tahun, 500gr">  <a href="images/201504/goods_img/1359_P_1429736556947.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1359'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1359_G_1429736556883.jpg" alt="Dancow Datita, Madu, 3-5 Tahun, 500gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1359_P_1429736556947.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1359_P_1429736556947.jpg"><img src="images/201504/thumb_img/1359_thumb_P_1429736556374.jpg" alt="Dancow Datita, Madu, 3-5 Tahun, 500gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1359)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Dancow Datita, Madu, 3-5 Tahun, 500gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>48,000</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>40,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>8,000</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">40 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">40 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1359)" class="sold_out"></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1359)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1359">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1359); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1359); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1359); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1359); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Dancow Datita, Madu, 3-5 Tahun, 500gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1359_G_1429736556883.jpg" alt="Dancow Datita, Madu, 3-5 Tahun, 500gr"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Madu</p></td>
                                            ...
                                            <tr >
                        <td>Berat Bersih</td>
                        <td><p class="fit_people ">500gr</p></td>
                      </tr>
                                            <tr >
                        <td>Kemasan</td>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;</p>
<h3>&nbsp; &nbsp;<strong><em>Dancow Datita 3-5 Tahun Madu 500gr</em></strong></h3>
<div class="active" id="tabs-description">
<div class="std">
<p>Susu ini cocok diminum oleh anak yang sedang mengalami  pertumbuhan dan kegiatan fisik yang cukup beragam. Susu ini mempunyai  kandungan gula yang lebih rendah 30% dan berbagai macam nutrisi penting  lainnya untuk bisa mendukung pertumbuhan yang optimal bagi si kecil.</p>
<p>&nbsp;</p>
<p><strong>Spesifikasi Produk</strong></p>
<p>Saran usia: 3-5 Tahun</p>
<p>Berat Bersih: 500gr</p>
<p>Kemasan: Karton</p>
<p>Rasa: Madu</p>
<p><strong>Manfaat</strong></p>
<ul>
    <li>Memberikan nutrisi untuk anak yang sedang mengalami pertumbuhan dan kegiatan fisik yang cukup beragam.</li>
    <li>Menunjang tumbuh kembang si kecil yang aktif</li>
    <li>Ekstra kandungan kalsium untuk pertumbuhan tulang si kecil</li>
</ul>
<p><strong>Kelebihan</strong></p>
<ul>
    <li>Mengandung Prebiotik Inulin, DHA, dan Kolin</li>
    <li>Membantu pertumbuhan anak</li>
    <li>Rasa yang nikmat</li>
    <li>Kandungan gula 30% lebih rendah</li>
    <li>Tidak membuat mual si kecil</li>
</ul>
<p><strong>Tentang Brand</strong></p>
<p><em>Dancow </em>merupakan salah satu produk dari perusahaan ternama asal Swiss yaitu <em>Nestle</em> yang sudah lama memproduksi berbagai macam makanan yang nikmat dan bergizi. <em>Nestle </em>sudah ada sejak tahun 1971 yang sampai saat ini memasok lebih dari 10 juta produknya ke berbagai negara setiap tahunnya.</p>
</div>
</div>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1359_thumb_G_1429736556240.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspDancow Datita, Madu, 3-5 Tahun, 500gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1359";}554fcae493e564ee0dc75bdf2ebf94ca</div>
