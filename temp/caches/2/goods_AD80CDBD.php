...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr">  <a href="images/201504/goods_img/1151_P_1429736674775.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1151'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1151_G_1429736674126.jpg" alt="Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1151_P_1429736674775.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1151_P_1429736674775.jpg"><img src="images/201504/thumb_img/1151_thumb_P_1429736674164.jpg" alt="Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1151)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>117,600</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>98,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>19,600</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">5 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">92 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">93 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1151)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1151)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1151">klik sini,share and get Rp3,000.</a></p>
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand-79-c0.html"><img src="data/brandlogo/1426578160916274570.png" border="0" width="180" height="100" alt="Dancow"></a> </div>
              <div class="detail_logo_txt">
                <p>Dancow</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand-79-c0.html" >visit</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1151); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1151); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1151); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1151); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1151_G_1429736674126.jpg" alt="Dancow NutriGold 3, Vanila, 1-3 Tahun, 700gr"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Vanila</p></td>
                                            ...
                                            <tr >
                        <td>Berat Bersih</td>
                        <td><p class="fit_people ">700gr</p></td>
                      </tr>
                                            <tr >
                        <td>Kemasan</td>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;</p>
<p>&nbsp;</p>
<h2>&nbsp; &nbsp;<strong>Dancow Nutrigold 3+ Vanilla 700Gr</strong></h2>
<p><b>&nbsp; </b>Merupakan susu  untuk Anak usia 1 sampai 3 tahun. Ini adalah masa emas yang menentukan  perkembangan anak di masa depan. Dorong tumbuh kembangnya dengan memilih  susu yang mampu memberi nutrisi terbaik. Dancow Nutrigold 3 adalah susu  bubuk dengan inovasi H-NUTRI (Holistic Nutrition), kombinasi nutrisi  yang memberi manfaat menyeluruh untuk si Kecil. Diperuntukkan bagi anak  usia 1-3 tahun, susu ini tersedia dalam rasa madu dan vanilla yang  disukai anak.</p>
<p>&nbsp;</p>
<p><strong>&nbsp; Mengandung Prebiotik &amp; DHA</strong><br />
Dancow Nutrigold 3 mengandung prebiotik Prebio 1 yang menjaga fungsi  saluran cerna dan&nbsp; BIFIDUS BL yang melindunginya dari serangan bakteri  dan virus penyebab diare. Selain itu, susu bubuk ini juga mengandung&nbsp;  Vitamin A, C dan E yang bekerja sebagai antioksidan pencegah radikal  bebas. Dancow Nutrigold 3 dilengkapi DHA dan ARA dengan kombinasi  seimbang yaitu 1:1. Sumber DHA yang berasal dari minyak ikan ini  didukung oleh Sialic Acid, Asam Linoleat dan Asam &alpha;-Linolenat untuk  membantu perkembangan otak.</p>
<p>&nbsp;</p>
<p><strong>&nbsp; </strong></p>
<p><strong>&nbsp; Menjaga Kesehatan Tulang &amp; Gigi</strong><br />
Dancow Nutrigold 3 mengandung kalsium yang berperan dalam pembentukan  tulang serta mempertahankan kepadatan tulang dan gigi. Disertai pula  dengan Protein untuk mendukung pertumbuhan fisik optimal.</p>
<p>&nbsp;</p>
<p><img alt="" src="http://ourlittlebabies.com/image/cache/data/Dancow/Dancow%20Nutrigold%203%20Vanila%20700gr%20(2)-600x600.jpg" width="600" height="600" /></p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1151_thumb_G_1429736674702.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspDancow NutriGold 3, Vanila, 1-3 Tahun, 700gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1151";}554fcae493e564ee0dc75bdf2ebf94ca</div>
