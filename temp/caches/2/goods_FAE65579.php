...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> S26 Promise, Vanila, 400gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="S26 Promise, Vanila, 400gr">  <a href="images/201503/goods_img/1696_P_1427756281276.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1696'); return false;"><img id="J_prodImg" src="images/201503/goods_img/1696_G_1427756281546.jpg" alt="S26 Promise, Vanila, 400gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201503/goods_img/1696_P_1427756281276.jpg" rel="zoom-id: Zoomer" rev="images/201503/goods_img/1696_P_1427756281276.jpg"><img src="images/201503/thumb_img/1696_thumb_P_1427756281681.jpg" alt="S26 Promise, Vanila, 400gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1696)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>S26 Promise, Vanila, 400gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：23 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>78,000</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>65,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>13,000</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">65 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">650 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1696)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1696)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1696">klik sini,share and get Rp3,000.</a></p>
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand-85-c0.html"><img src="data/brandlogo/1427064227059422246.jpg" border="0" width="180" height="100" alt="S26"></a> </div>
              <div class="detail_logo_txt">
                <p>S26</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand-85-c0.html" >visit</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1696); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1696); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1696); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1696); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> S26 Promise, Vanila, 400gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201503/goods_img/1696_G_1427756281546.jpg" alt="S26 Promise, Vanila, 400gr"  /></td>
                      </tr>
                      
                       
                                            <tr >
                        <td>Tahap</td>
                        <td><p class="fit_people ">4</p></td>
                      </tr>
                                            <tr >
                        <td>Usia</td>
                        ...
                        <td><p class="fit_people ">Vanila</p></td>
                                            ...
                                            <tr >
                        <td>Berat Bersih</td>
                        <td><p class="fit_people ">400gr</p></td>
                      </tr>
                                            <tr >
                        <td>Kemasan</td>
                        <td><p class="fit_people ">Karton</p></td>
                                            ...
                                            <tr >
                        <td>Produsen</td>
                        <td><p class="fit_people ">Wyeth</p></td>
                      </tr>
                                            <tr >
                        <td>Negara Produsen</td>
                        <td><p class="fit_people ">Amerika</p></td>
                      </tr>
                                            <tr >
                        <td>Diproduksi di</td>
...
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Pertumbuhan anak merupakan perhatian utama para orang tua, demi masa depan yang cemerlang.</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Tunjang tumbuh kembang buah hati Anda dengan memilih susu yang tepat untuk asupan nutrisi terbaik.</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">S26 Promise adalah susu pertumbuhan dalam bentuk bubuk yang telah diperkaya dengan nutrisi penting untuk tumbuh kembang anak,</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">serta energi 240 kalori dalam setiap sajiannya untuk kebutuhan beraktivitas sehari-hari.</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">S26 Promise ini diformulasikan khusus untuk anak berusia 3-7 tahun.</span><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;" />
...
<strong style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Mengandung Nutrisi, Mineral, &amp; Kalsium</strong><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;" />
<span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">S26 Promise mengandung berbagai nutrisi yang bermanfaat untuk tumbuh kembang anak, seperti Omega 3, Omega 6, serta vitamin untuk daya tahan tubuhnya.</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Kandungan mineral penting seperti zat besi dan kalsium juga terkandung di dalamnya, memberikan anak kebutuhan gizi sempurna sehari-hari.</span><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;" />
<br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;" />
<strong style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Rasa Lezat</strong><br style="margin: 0px; padding: 0px; color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;" />
<span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">S26 Promise mengerti kebutuhan buah hati Anda, karenanya dibuatlah susu pertumbuhan berbentuk bubuk dengan rasa lezat yang dapat dinikmati oleh anak Anda.</span></div>
<div><span style="color: rgb(64, 64, 64); font-family: Helvetica, Arial, sans-serif; line-height: 22.7999992370605px; text-align: justify;">Dengan rasa yang lezat, anak akan meminum susu ini tanpa harus dipaksa. Tumbuh kembang anak terjaga, si kecil pun senang.</span></div>
</div>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201503/thumb_img/1696_thumb_G_1427756281088.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspS26 Promise, Vanila, 400gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1696";}554fcae493e564ee0dc75bdf2ebf94ca</div>
