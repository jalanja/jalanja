...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> Chil Mil Platinum 2, 7-11 Bulan, 800gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Chil Mil Platinum 2, 7-11 Bulan, 800gr">  <a href="images/201504/goods_img/787_P_1429501432479.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=787'); return false;"><img id="J_prodImg" src="images/201504/goods_img/787_G_1429501432220.jpg" alt="Chil Mil Platinum 2, 7-11 Bulan, 800gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/787_P_1429501432479.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/787_P_1429501432479.jpg"><img src="images/201504/thumb_img/787_thumb_P_1429501432123.jpg" alt="Chil Mil Platinum 2, 7-11 Bulan, 800gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(787)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Chil Mil Platinum 2, 7-11 Bulan, 800gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：11 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>296,400</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>247,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>49,400</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">47 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">232 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">2320 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(787)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(787)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=787">klik sini,share and get Rp3,000.</a></p>
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand-82-c0.html"><img src="data/brandlogo/1426578396660490999.png" border="0" width="180" height="100" alt="Morinaga"></a> </div>
              <div class="detail_logo_txt">
                <p>Morinaga</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand-82-c0.html" >visit</a> </div>
            </div>
          </form>
        </div>
      </div>
...
<h2 class="mall_leftTitle c333">Releate Product</h2>
 <ul class="pro_list">
        ...
        <p class="already_sold">Sold 2 pcs</p>
        <p class="pro_price">
        ...
        <a href="mamypoko-tipe-standard-M-Universal">
             ...
             <li>
        <a href="goon-tape-m40" class="pro_pic"><img src="images/201505/thumb_img/987_thumb_G_1432698994855.jpg" alt="GOO.N Tape, Size M, 40pcs"  width="120" height="120"/></a>
        <a href="goon-tape-m40" title="GOO.N Tape, Size M, 40pcs" class="pro_title">GOO.N Tape, Size M, 40pcs</a>
        <p class="already_sold">Sold 2 pcs</p>
        <p class="pro_price">
        <a href="goon-tape-m40">
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 787); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 787); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),787); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),787); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Chil Mil Platinum 2, 7-11 Bulan, 800gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/787_G_1429501432220.jpg" alt="Chil Mil Platinum 2, 7-11 Bulan, 800gr"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">2</p></td>
                                            ...
                                            <tr >
                        <td>Usia</td>
                        <td><p class="fit_people ">Bayi 7-11 Bulan</p></td>
                      </tr>
                                            <tr >
                        <td>Rasa</td>
                        ...
                        <td><p class="fit_people ">Kaleng</p></td>
                                            ...
                                            <tr >
                        <td>Produsen</td>
                        <td><p class="fit_people ">Kalbe</p></td>
                      </tr>
                                            <tr >
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;</p>
<p>&nbsp;<img src="/images/upload/Image/morinaga/CHILMIL-PLATINUM.jpg" width="700" height="1482" alt="" /></p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/787_thumb_G_1429501432257.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspChil Mil Platinum 2, 7-11 Bulan, 800gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:3:"787";}554fcae493e564ee0dc75bdf2ebf94ca</div>
