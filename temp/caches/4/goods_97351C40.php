...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> Chil School Platinum 4, madu, 3-12 Tahun, 800gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Chil School Platinum 4, madu, 3-12 Tahun, 800gr">  <a href="images/201503/goods_img/1670_P_1427674347421.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1670'); return false;"><img id="J_prodImg" src="images/201503/goods_img/1670_G_1427674347943.jpg" alt="Chil School Platinum 4, madu, 3-12 Tahun, 800gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201503/goods_img/1670_P_1427674347421.jpg" rel="zoom-id: Zoomer" rev="images/201503/goods_img/1670_P_1427674347421.jpg"><img src="images/201503/thumb_img/1670_thumb_P_1427674347265.jpg" alt="Chil School Platinum 4, madu, 3-12 Tahun, 800gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1670)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Chil School Platinum 4, madu, 3-12 Tahun, 800gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>226,800</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>189,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>37,800</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">189 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">1890 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1670)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1670)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1670">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1670); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1670); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1670); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1670); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Chil School Platinum 4, madu, 3-12 Tahun, 800gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201503/goods_img/1670_G_1427674347943.jpg" alt="Chil School Platinum 4, madu, 3-12 Tahun, 800gr"  /></td>
                      </tr>
...
<p>&nbsp;<em style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12.2222px; line-height: 18px; color: rgb(0, 100, 0);"><strong>Chil School Platinum Madu 800gr.</strong></em></p>
</span></p>
<div id="tab-description" class="tab-content">
<p><span style="color: rgb(0, 0, 0);"><span style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12.2222px; line-height: 18px;">Merupakan  susu pertumbuhan dengan komposisi makronutrient dan mikronutrient yang  terkandung didalamnya membantu kebutuhan nutrisi anak Anda agar tumbuh  secara optimal. Dibuat dalam nutrisi platinum sehingga sangat baik untuk  membantu tumbuh kembangnya anak dengan optimal. Tersedia dalam kemasan  800 gram dengan rasa madu.</span></span></p>
</div>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201503/thumb_img/1670_thumb_G_1427674347150.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspChil School Platinum 4, madu, 3-12 Tahun, 800gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1670";}554fcae493e564ee0dc75bdf2ebf94ca</div>
