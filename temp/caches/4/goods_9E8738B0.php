...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr">  <a href="images/201504/goods_img/1691_P_1429663553976.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1691'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1691_G_1429663553011.jpg" alt="S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1691_P_1429663553976.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1691_P_1429663553976.jpg"><img src="images/201504/thumb_img/1691_thumb_P_1429663553789.jpg" alt="S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1691)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > Jumlah produk yang diklik：21 </p>
                  <p> 
                     
                    <span class="goods_attr_width">Market Price</span>：Rp<span>396,000</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>330,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>66,000</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">330 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">3300 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1691)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1691)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1691">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1691); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1691); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1691); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1691); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1691_G_1429663553011.jpg" alt="S26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Vanila</p></td>
                                            ...
                                            <tr >
                        <td>Berat Bersih</td>
                        <td><p class="fit_people ">1400gr</p></td>
                      </tr>
                                            <tr >
                        <td>Kemasan</td>
                        ...
                        <td><p class="fit_people ">1.5kg</p></td>
                      </tr>
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>&nbsp;Susu pertumbuhan ini memiliki rasa yang nikmat serta kandungan vitaminnya yang berlimpah. Susu ini sangat cocok diminum oleh anak yang berusia 1 sampai 3 tahun yang sedang mengalami pertumbuhan dan kegiatan fisiknya yang cukup beragam. Susu ini mempunyai berbagai macam nutrisi penting untuk bisa mendukung pertumbuhan yang optimal bagi si kecil.</p>
<p><br />
<b>Manfaat</b></p>
<ol>
    <li>Memberikan nutrisi untuk anak pada usia 1-3 tahun yang sedang mengalami pertumbuhan dan kegiatan fisik yang cukup beragam.</li>
    <li>Menunjang tumbuh kembang si kecil yang aktif</li>
    <li>Ekstra kandungan kalsium untuk pertumbuhan tulang si kecil<br />
    &nbsp;</li>
</ol>
<p><b>Kelebihan</b></p>
<ol>
    <li>Mengandung Kalsium, Protein, Zat Besi, dan Zinc</li>
    <li>Mengandung Mineral dan Vitamin</li>
    <li>Mengandung DHA dan zat besi</li>
    ...
    <li>Tidak membuat mual si kecil</li>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1691_thumb_G_1429663553509.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspS26 Procal Gold 3, Vanila, 1-3 Tahun, 1400gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1691";}554fcae493e564ee0dc75bdf2ebf94ca</div>
