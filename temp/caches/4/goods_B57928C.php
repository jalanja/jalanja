...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-154-b0.html">Perlengkapan Baby</a> <code>&gt;</code> <a href="category-152-b0.html">Popok</a> <code>&gt;</code> <a href="category-162-b0.html">L</a> <code>&gt;</code> Sensi Regular Pants L20 </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Sensi Regular Pants L20">  <a href="images/201505/goods_img/1774_P_1430791116791.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1774'); return false;"><img id="J_prodImg" src="images/201505/goods_img/1774_G_1430791116350.jpg" alt="Sensi Regular Pants L20" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201505/goods_img/1774_P_1430791116791.jpg" rel="zoom-id: Zoomer" rev="images/201505/goods_img/1774_P_1430791116791.jpg"><img src="images/201505/thumb_img/1774_thumb_P_1430791116281.jpg" alt="Sensi Regular Pants L20"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1774)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Sensi Regular Pants L20</a></div>
            <div class="detail_center">
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">420 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1774)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1774)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1774">klik sini,share and get Rp3,000.</a></p>
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand-107-c0.html">Sensi</a> </div>
              <div class="detail_logo_txt">
                <p>Sensi</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand-107-c0.html" >visit</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1774); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1774); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1774); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1774); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Sensi Regular Pants L20</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201505/goods_img/1774_G_1430791116350.jpg" alt="Sensi Regular Pants L20"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">Celana</p></td>
                                            ...
                                            <tr >
                        <td>Isi Kemasan</td>
                        <td><p class="fit_people ">20 pcs</p></td>
                      </tr>
                                            <tr >
			  ...
			  <div class="inLeft_comment" style="background:url(themes/miqinew/images/detailPicBg.gif) 0 0 repeat;">
			   <div style="width:660px;background-color:#ffffff">
			    <p>Sensi Regular Pants L-20  	Sensi Regular Pants L-20&nbsp;adalah popok siap pakai. &nbsp;Cocok untuk bayi yang memiliki berat 9-14kg.</p>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201505/thumb_img/1774_thumb_G_1430791116362.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspSensi Regular Pants L20&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1774";}554fcae493e564ee0dc75bdf2ebf94ca</div>
