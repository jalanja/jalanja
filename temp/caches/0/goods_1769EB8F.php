...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-165-b0.html">Susu Bayi</a> <code>&gt;</code> <a href="category-183-b0.html">Susu Anak</a> <code>&gt;</code> Dancow Datita, Vanila, 3-5 Tahun, 1000gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Dancow Datita, Vanila, 3-5 Tahun, 1000gr">  <a href="images/201504/goods_img/1380_P_1429736371958.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1380'); return false;"><img id="J_prodImg" src="images/201504/goods_img/1380_G_1429736371982.jpg" alt="Dancow Datita, Vanila, 3-5 Tahun, 1000gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201504/goods_img/1380_P_1429736371958.jpg" rel="zoom-id: Zoomer" rev="images/201504/goods_img/1380_P_1429736371958.jpg"><img src="images/201504/thumb_img/1380_thumb_P_1429736371875.jpg" alt="Dancow Datita, Vanila, 3-5 Tahun, 1000gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1380)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Dancow Datita, Vanila, 3-5 Tahun, 1000gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>86,400</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>72,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>14,400</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">72 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">720 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1380)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1380)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1380">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1380); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1380); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1380); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1380); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Dancow Datita, Vanila, 3-5 Tahun, 1000gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201504/goods_img/1380_G_1429736371982.jpg" alt="Dancow Datita, Vanila, 3-5 Tahun, 1000gr"  /></td>
                      </tr>
...
<ul>
    <li>Memberikan nutrisi untuk anak pada usia diatas 1 tahun yang sedang mengalami pertumbuhan dan kegiatan fisik yang cukup beragam.</li>
...
<p>&nbsp;</p>			   </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201504/thumb_img/1380_thumb_G_1429736371134.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspDancow Datita, Vanila, 3-5 Tahun, 1000gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1380";}554fcae493e564ee0dc75bdf2ebf94ca</div>
