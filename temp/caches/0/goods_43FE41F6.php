...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>Your position:</span> <a href=".">Home</a> <code>&gt;</code> <a href="category-153-b0.html">Baby Feeding</a> <code>&gt;</code> <a href="category-194-b0.html">Food</a> <code>&gt;</code> <a href="category-198-b0.html">Bubur</a> <code>&gt;</code> Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr">  <a href="images/201505/goods_img/1807_P_1430778235569.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=1807'); return false;"><img id="J_prodImg" src="images/201505/goods_img/1807_G_1430778235921.jpg" alt="Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201505/goods_img/1807_P_1430778235569.jpg" rel="zoom-id: Zoomer" rev="images/201505/goods_img/1807_P_1430778235569.jpg"><img src="images/201505/thumb_img/1807_thumb_P_1430778235433.jpg" alt="Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(1807)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p> 
                    ...
                    <span class="goods_attr_width">Market Price</span>：Rp<span>20,400</span> 
                     
                  </p>
                   
				                    <b><i class="goods_attr_width">Jalanja Price: </i>：<font  id="ECS_SHOPPRICE">Rp<span>17,000</span></font></b>
                  				  <p style="display:none" > 
                     
                  </p>
                  <p><i class="goods_attr_width">Saving</i>：Rp<span>3,400</span>（17% Off）</p>
                <!--  <p><i class="goods_attr_width">Sold</i>： <span style="color: #4c4c4c;">0 pcs</span></p> -->
				  ...
				  <p>
                   <i class="goods_attr_width">You get Point</i>：<font class="f4">17 Poin</font> 
                  </p>
              ...
              <div class="center_txt clearfix"> 
                                <p><strong>Maximum Point to use</strong>：<font class="f4">170 Poin</font></p>
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"><a href="javascript:addToCartShowDiv(1807)" ></a></div>
                  <div class="center_collect_btn"> <a href="javascript:collect(1807)">Wishlist</a> </div>
    ...
    <a href="flow.php"></a>
              ...
              <div class="center_bottom">
                <div class="center_buy"> 
                                    <p><a href="user.php?act=affiliate&goodsid=1807">klik sini,share and get Rp3,000.</a></p>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 1807); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 1807); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),1807); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),1807); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>Product Name</td>
                        <td><p class="fit_people "> Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201505/goods_img/1807_G_1430778235921.jpg" alt="Milna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr"  /></td>
                      </tr>
...
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;"><em style="margin: 0px; padding: 0px; border: 0px currentColor;"><strong style="margin: 0px; padding: 0px; border: 0px currentColor;">Milna Bubur Bayi 9+ Semur Daging 120 gr.</strong></em></div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">&nbsp;</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">Bubur bayi Milna dilengkapi gizi dengan formula 4 sehat 5 sempurna agar adik tumbuh lebih sehat dan cerdas.</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">Keunggulan Milna Bubur Bayi:</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">DHA, Omega 3 &amp; 6: membantu pertumbuhan otak</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">Mengandung 5 zat gizi penting (4  Sehat 5 Sempurna): Karbohidrat, Protein, Vitamin, Mineral, dan Susu  &nbsp;untuk pertumbuhan sehatnya.</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">9 Asam Amino Esensial: untuk pertumbuhan dan perkembangan optimal</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">Prebiotik FOS: menjaga kesehatan saluran cerna bayi.</div>
<div style="margin: 0px; padding: 0px; border: 0px currentColor; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif;">Tinggi Kalsium: pertumbuhan tulang dan gigi</div>
</div>			   </div>
			  </div>
              ...
              <div class="inLeft_title " id="coms1"><img border="0" src="themes/miqinew/images/inLeft_title06.gif"></div>          
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201505/thumb_img/1807_thumb_G_1430778235224.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>Terbeli&nbspMilna Bubur Bayi  Semur Daging, 9 bulan+ 120 gr&nbsp only review after products received</div> 
              ...
              <div class="comment_body " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";s:4:"1807";}554fcae493e564ee0dc75bdf2ebf94ca</div>
